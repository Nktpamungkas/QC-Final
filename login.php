...
<div class="login-box">
  ...
  <a href="index.php"><b>QCF ITTI</b></a>
...
if($_POST){ //login user
  ...
  $sql="SELECT * FROM user_login WHERE user='$username' AND password='$password' AND (dept = 'QC' OR dept = 'MKT' OR dept = 'DYE' OR dept = 'FIN' OR dept = 'KNT' OR dept = 'BRS' OR dept = 'RMP' OR dept='PRO' OR dept='YND' OR dept='PRT' OR dept='KNT' OR dept='GAS' OR dept='TAS' OR dept='PPC' OR dept='DMF' OR dept='LAB') LIMIT 1";

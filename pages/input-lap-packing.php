            ...
            <label for="shift" class="col-sm-3 control-label">Shift</label>
                    <div class="col-sm-2">
                        <select class="form-control chosen-select" name="shift" required id="shift" onchange="proses_shift()">
                            ...
                            <option value="INSPEKMEJA1" <?php if($_GET['shift']=="INSPEKMEJA1"){echo "SELECTED";}?>>INSPEK MEJA 1</option>
                            <option value="INSPEKMEJA2" <?php if($_GET['shift']=="INSPEKMEJA2"){echo "SELECTED";}?>>INSPEK MEJA 2</option>
                            <option value="INSPEKMEJA3" <?php if($_GET['shift']=="INSPEKMEJA3"){echo "SELECTED";}?>>INSPEK MEJA 3</option>
                        </select>
                    </div>
            </div>
            <div class="form-group">
				...
				<label for="inspektor" class="col-sm-3 control-label">Group</label>
                    ...
                    <?php if($crow>0){$grup=$row['inspektor'];}else{$grup=$rp['user_packing'];}?>
                        <select class="form-control select2" name="inspektor" required>
                            ...
                            <option value="INSPEK MEJA A" <?php if($grup=="INSPEK MEJA A"){echo "SELECTED";}?>>INSPEK MEJA A</option>
                            <option value="INSPEK MEJA B" <?php if($grup=="INSPEK MEJA B"){echo "SELECTED";}?>>INSPEK MEJA B</option>
                            <option value="INSPEK MEJA C" <?php if($grup=="INSPEK MEJA C"){echo "SELECTED";}?>>INSPEK MEJA C</option>
                        </select>
                    </div>
            </div>
            <div class="form-group">

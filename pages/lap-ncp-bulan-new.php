...
<div class="row">
  ...
  <div class="col-xs-5">	
	...
	if($Cancel !="1"){
		...
		$sts="  ";
            ...
            $totaldDis=0;
            $totaldllDis=0;
            $qryAll=mysqli_query($con,"SELECT COUNT(*) AS jml_all, SUM(berat) AS berat_all FROM tbl_ncp_qcf_new WHERE $WKategori no_ncp LIKE '".$Tahun1."/".$Bulan."/%' AND (masalah_dominan!='' OR masalah_dominan!=NULL) $sts ");
            $rAll=mysqli_fetch_array($qryAll);
            $qryAllDis=mysqli_query($con,"SELECT COUNT(*) AS jml_all, SUM(berat) AS berat_all FROM tbl_ncp_qcf_new WHERE $WKategori no_ncp LIKE '".$Tahun1."/".$Bulan."/%' AND (masalah_dominan!='' OR masalah_dominan!=NULL) AND `status`='Disposisi' $sts ");
            $rAllDis=mysqli_fetch_array($qryAllDis);
            $qrydef=mysqli_query($con,"SELECT SUM(berat) AS berat, ROUND(COUNT(masalah_dominan)/(SELECT COUNT(*) FROM tbl_ncp_qcf_new WHERE $WKategori no_ncp LIKE '".$Tahun1."/".$Bulan."/%' $sts
			...
			$qryBDominan=mysqli_query($con,"SELECT COUNT(*) AS jml_all, SUM(berat) AS berat_all FROM tbl_ncp_qcf_new WHERE $WKategori no_ncp LIKE '".$Tahun1."/".$Bulan."/%' AND (masalah_dominan='' OR masalah_dominan=NULL) $sts ");
            $rBD=mysqli_fetch_array($qryBDominan); 
			$qryAllDisBD=mysqli_query($con,"SELECT COUNT(*) AS jml_all, SUM(berat) AS berat_all FROM tbl_ncp_qcf_new WHERE $WKategori no_ncp LIKE '".$Tahun1."/".$Bulan."/%' AND (masalah_dominan='' OR masalah_dominan=NULL) AND `status`='Disposisi' $sts ");
            $rAllDisBD=mysqli_fetch_array($qryAllDisBD);  
            while($rd=mysqli_fetch_array($qrydef)){
              $qrydefDis=mysqli_query($con,"SELECT SUM(berat) AS berat, ROUND(COUNT(masalah_dominan)/(SELECT COUNT(*) FROM tbl_ncp_qcf_new WHERE $WKategori no_ncp LIKE '".$Tahun1."/".$Bulan."/%' AND `status`='Disposisi' AND masalah_dominan='$rd[masalah_dominan]' $sts
              AND (masalah_dominan!='' OR masalah_dominan!=NULL))*100,1) AS persen,
              masalah_dominan
              FROM
              `tbl_ncp_qcf_new`
  ...
  <div class="col-xs-5">	
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped" style="width: 100%;">
          ...
          <tbody>
            ...
            $totaldptDis=0;
            $totaldlldptDis=0;			
            $qryAllDpt=mysqli_query($con,"SELECT COUNT(*) AS jml_all, SUM(berat) AS berat_all FROM tbl_ncp_qcf_new WHERE no_ncp LIKE '".$Tahun1."/".$Bulan."/%' AND (dept!='' OR dept!=NULL) AND NOT status='Cancel' AND ncp_hitung='ya' ");
            $rAllDpt=mysqli_fetch_array($qryAllDpt);
            $qryAllDptDis=mysqli_query($con,"SELECT COUNT(*) AS jml_all, SUM(berat) AS berat_all FROM tbl_ncp_qcf_new WHERE no_ncp LIKE '".$Tahun1."/".$Bulan."/%' AND (dept!='' OR dept!=NULL) AND `status`='Disposisi' AND NOT status='Cancel' AND ncp_hitung='ya' ");
            $rAllDptDis=mysqli_fetch_array($qryAllDptDis);
            $qrydpt=mysqli_query($con,"SELECT SUM(berat) AS berat, ROUND(COUNT(dept)/(SELECT COUNT(*) FROM tbl_ncp_qcf_new WHERE no_ncp LIKE '".$Tahun1."/".$Bulan."/%' AND NOT status='Cancel'
            ...
            while($rdpt=mysqli_fetch_array($qrydpt)){
              $qrydptDis=mysqli_query($con,"SELECT SUM(berat) AS berat, ROUND(COUNT(dept)/(SELECT COUNT(*) FROM tbl_ncp_qcf_new WHERE no_ncp LIKE '".$Tahun1."/".$Bulan."/%' AND `status`='Disposisi' AND dept='$rdpt[dept]' AND NOT status='Cancel'
              AND (dept!='' OR dept!=NULL))*100,1) AS persen,
              dept
              FROM
              `tbl_ncp_qcf_new`
	...
	$qry1=mysqli_query($con,"SELECT * FROM tbl_ncp_qcf_new WHERE $Wdept $WKategori no_ncp LIKE '".$Tahun1."/".$Bulan."/%' $sts ORDER BY id ASC");
	$qrySUM=mysqli_query($con,"SELECT COUNT(*) as Lot, SUM(rol) as Rol,SUM(berat) as Berat FROM tbl_ncp_qcf_new WHERE $Wdept $WKategori no_ncp LIKE '".$Tahun1."/".$Bulan."/%' $sts ");

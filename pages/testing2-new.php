...
$nokk=$_GET['nokk'];
$notes=$_GET['no_test'];
$sqlCek=mysqli_query($con,"SELECT * FROM tbl_tq_nokk WHERE nokk='$nokk' AND no_test='$notes'");
      			...
      			<div class="form-group">
                  	...
                  	<div class="col-sm-4">
				  		<div class="input-group">	  
                     		...
                     		onchange="window.location='Testing2New-'+this.value" value="<?php echo $_GET['nokk'];?>" placeholder="No KK" required readonly>
					  	</div>	  
		  			</div><?php if($cek>0){?><a href="#" class="btn btn-info btn-xs posisi_kktq" id="<?php echo $_GET['nokk']; ?>">Posisi Terakhir</a><?php }?>
                </div>
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						value="<?php echo $_GET['no_test']; ?>" readonly="readonly" >
					</div>				   
				</div>
	           <div class="form-group">
...
`tgl_update`=now()");
		...
		if (result.value) {
			...
			window.location.href='Testing2New-$nokk-$notes'; 
		}
		});</script>";
	 }
...
if($nokk!="" and $cek==0){
  ...
  if (result.value) {
	 ...
	 window.location.href='Testing2New'; 
  }
});</script>";
}
?>

...
<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title"> Filter Laporan Kesesuaian Colorist</h3>
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
            <h3 class="box-title">Data Kesesuaian Colorist</h3><br>
            ...
            <div class="pull-right">
                ...
                <a href="pages/cetak/lap-kesesuaian_colorist-excel.php?awal=<?php echo $_POST['awal']; ?>&akhir=<?php echo $_POST['akhir']; ?>&shift=<?php echo $_POST['gshift']; ?>" class="btn btn-primary <?php if($_POST['awal']=="") { echo "disabled"; }?>" target="_blank">Cetak Excel</a> 
            </div>
      </div>
      <div class="box-body">
        <table class="table table-bordered table-hover table-striped nowrap" id="example1" style="width:100%">
          <thead class="bg-blue">
            <tr>
              ...
              <th colspan="4">NCP</th>
              <th rowspan="2"><div align="center">No Barcode</div></th>
            ...
            <tr>
              ...
              <th><div align="center">Tgl NCP</div></th>
            ...
            if($Awal!="" and $Akhir!=""){
              ...
              $qry1=mysqli_query($con,"SELECT * FROM tbl_cocok_warna_dye WHERE `dept`='QCF' $where $shft ORDER BY id ASC");
                ...
                while($row1=mysqli_fetch_array($qry1)){
					$qryNCP=mysqli_query($con,"SELECT * FROM tbl_ncp_qcf_new WHERE `dept`='DYE' AND masalah='Beda Warna' AND ncp_hitung='ya' AND nokk='$row1[nokk]' ");
					$rowN=mysqli_fetch_array($qryNCP);
					$qryFIN=mysqli_query($con,"SELECT * FROM tbl_lap_inspeksi WHERE `dept`='QCF' AND proses='Fin' AND nokk='$row1[nokk]' ");
          ...
          <tr bgcolor="<?php echo $bgcolor; ?>">
            ...
            <td align="center"><?php echo $rowN['no_ncp_gabungan'];?></td>
            <td align="center"><?php echo substr($rowN['tgl_buat'],0,10);?></td>
            <td align="left"><?php echo $rowN['penyelesaian'];?></td>
            <td align="left"><?php echo $rowN['ket'];?></td>
            ...
            <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['status_warna'] ?>" class="sts_warna" href="javascipt:void(0)"><?php echo $rowF['tgl_update'] ?></a></td>
            <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['status_warna'] ?>" class="sts_warna" href="javascipt:void(0)"><?php echo $rowF['status'] ?></a></td>
            <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['disposisi'] ?>" class="disposisi_cdye" href="javascipt:void(0)"><?php echo $rowF['disposisi'] ?></a></td>
            <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['colorist_qcf'] ?>" class="colorist_qcf" href="javascipt:void(0)"><?php echo $rowF['colorist_qcf'] ?></a></td>
            <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['review_qcf'] ?>" class="review_qcf" href="javascipt:void(0)"><?php echo $row1['review_qcf'] ?></a></td>
            <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['remark_qcf'] ?>" class="remark_qcf" href="javascipt:void(0)"><?php echo $row1['remark_qcf'] ?></a></td>
            </tr>
          <?php	$no++;  } ?>

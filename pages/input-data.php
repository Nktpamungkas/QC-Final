 ...
 <div class="box box-info">
  ...
  <div class="box-body"> 
		    ...
		    <div class="form-group">
		 		...
		 		<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    value="<?php if($cek>0 AND $rcek['sales']!=NULL){echo $rcek['sales'];}else if($r['SalesPersonName']!=""){echo trim($r['SalesPersonName']);} ?>" placeholder="Sales" readonly>
                  </div>				   
                </div>
	  </div>
	  		<!-- col --> 
   ...
   <?php } ?>				   
	...
	<!-- <div class="form-group">
	 	<label for="lot_erp_qcf" class="col-sm-3 control-label">Tgl Deliv</label>
			<div class="col-sm-5">
                <input name="lot_erp_qcf" type="text" class="form-control" id="lot_erp_qcf" 
                value="<?php if($cek>0){echo $rcek['no_ko'];}else{echo $rKO['KONo'];}?>" placeholder="Lot ERP" >
                </div>	
	 </div>  -->
	 </div>

...
<em><strong>Kartu Kerja Induk= <?php echo $modal_id; ?>	</strong></em>			  
  ...
  <tbody >
    <tr class="label-danger">
      ...
      <th style="text-align: center" scope="col">Nokk Salinan</th>
      </tr>
	<?php $qCek=mysqli_query($con,"SELECT tgl_buat,no_ncp_gabungan,masalah,masalah_dominan,nokk_salinan FROM tbl_ncp_qcf_new WHERE nokk='$modal_id'");
    ...
    <tr>
      ...
      <td><?php echo $dCek['nokk_salinan']; ?></td>
      </tr>
	  <?php } ?>
  </tbody>
</table>

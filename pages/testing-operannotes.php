                  ...
                  <label for="no_po" class="col-sm-3 control-label">No KK</label>
                  	<div class="col-sm-4">
						<div class="input-group">	  
							...
							onchange="window.location='TestingOperan-'+this.value" value="<?php if($cek>0){echo $rcek['nokk'];}else{echo $_GET['nokk'];} ?>" placeholder="No KK" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>	  
		  			</div>
            </div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					onchange="window.location='TestingOperanNoTes-'+this.value" value="<?php if($_GET['notest']!=""){echo $_GET['notest'];}else{echo $notes_post;}?>"  >
				</div>				   
			</div>
	        <div class="form-group">
				...
				<div class="tab-pane active" id="tab_1">
					<form class="form-horizontal" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
						...
						<div class="form-group" id="dispb" style="display:none;">
							...
							<div class="col-sm-1">
								<input name="dpillingb_f1" type="text" class="form-control" id="dpillingb_f1" value="<?php echo $rcekD['dpb_f1'];?>" placeholder="FACE 1">
						...
						<div class="form-group" id="ranpb" style="display:none;">
							...
							<div class="col-sm-1">
								<input name="rpillingb_f1" type="text" class="form-control" id="rpillingb_f1" value="<?php echo $rcekR['rpb_f1'];?>" placeholder="FACE 1" readonly>
...
if($_POST['physical_save']=="save" AND $cekNew>0){
	...
	$sqlPHYDI=mysqli_query($con,"INSERT INTO tbl_tq_disptest SET 	
		...
		if (result.value) {
			...
			window.location.href='TestingOperanNoTes-$notes'; 
		}
		});</script>";
	}
...
if($nokk!="" and $cek==0){
  ...
  if (result.value) {
	 ...
	 window.location.href='TestingOperanNoTes'; 
  }
});</script>";
}
?>

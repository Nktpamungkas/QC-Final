...
$sqlCek=mysqli_query($con,"SELECT * FROM tbl_tq_nokk WHERE nokk='$nokk' ORDER BY id DESC LIMIT 1");
                  ...
                  <label for="no_po" class="col-sm-3 control-label">No KK</label>
                  	<div class="col-sm-4">
						<div class="input-group">	  
							...
							onchange="window.location='TestingNew-'+this.value" value="<?php echo $_GET['nokk'];?>" placeholder="No KK" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>	  
					</div><?php if($_GET['nokk']!=""){?><a href="#" class="btn btn-info btn-xs posisi_kktq" id="<?php echo $_GET['nokk']; ?>">Posisi Terakhir</a><?php }?>
            </div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					onchange="window.location='TestingNewNoTes-'+this.value" value="<?php if($cek>0){echo $rcek['no_test'];}else{echo $_GET['no_test'];} ?>" >
				</div>				   
			</div>
	        <div class="form-group">
					...
					<form class="form-horizontal" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
						...
						<div class="form-group" id="fc24" style="display:none;">
							...
							<div class="col-sm-1">
								...
								<input name="apperss_cc3" type="text" class="form-control" id="apperss_cc3" value="<?php echo $rcek1['apperss_cc23'];?>" placeholder="C.CHANGE 3">
...
if($_POST['physical_save']=="save" and $cek1>0){
	...
	$sqlPHYD=mysqli_query($con,"UPDATE tbl_tq_disptest SET 
		...
		`drecover_l11`='$_POST[drecover_l11]',
	...
	$sqlPHYDI=mysqli_query($con,"INSERT INTO tbl_tq_disptest SET 	
		...
		if (result.value) {
			...
			window.location.href='TestingNew-$nokk'; 
		}
		});</script>";
	 }
...
if($nokk!="" and $cek==0){
  ...
  if (result.value) {
	 ...
	 window.location.href='TestingNew'; 
  }
});</script>";
}
?>

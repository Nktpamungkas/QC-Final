                  ...
                  <label for="no_po" class="col-sm-3 control-label">No KK</label>
                  	<div class="col-sm-4">
						<div class="input-group">	  
							...
							onchange="window.location='ReportFLLululemon-'+this.value" value="<?php if($cek>0){echo $rcek['nokk'];}else{echo $_GET['nokk'];} ?>" placeholder="No KK" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>	  
		  			</div>
            </div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					onchange="window.location='ReportFLLululemonNoTes-'+this.value" value="<?php if($_GET['notest']!=""){echo $_GET['notest'];}else{echo $notes_post;}?>" >
				</div>				   
			</div>
	        <div class="form-group">
...
`tgl_update`=now()");
		...
		if (result.value) {
			...
			window.location.href='ReportFLLululemonNoTes-$notes'; 
		}
		});</script>";
	}
...
if($nokk!="" and $cek==0){
  ...
  if (result.value) {
	 ...
	 window.location.href='ReportFLLululemonNoTes'; 
  }
});</script>";
}
?>

    ...
    <div class="box-body">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input name="demand_erp" class="form-control" type="text" id="demand_erp" value="<?php echo $row['demand_erp'];?>" placeholder="Demand ERP" required>
                </div>
            </div>
            <div class="form-group">
                <label for="noprodorder" class="col-sm-3 control-label">Prod. Order ERP</label>
                <div class="col-sm-5">
                    <input name="noprodorder" class="form-control" type="text" id="noprodorder" value="<?php echo $row['noprodorder'];?>" placeholder="Prod. Order ERP" required>
                </div>
            </div>
            <div class="form-group">

  ...
  <div class="col-xs-6">	
    <div class="box box-success">
      <div class="box-header with-border">
        ...
        <?php if($Tahun!="") { ?><br><b>Periode: <?php echo tanggal_indo($Tahun."-".$Bulan); }?> Ket: <?php if($Kategori=="ALL"){echo "ALL";}elseif($Kategori=="hitung"){echo "NCP dihitung";}elseif($Kategori=="tidakhitung"){echo "NCP tidak dihitung";}elseif($Kategori=="gerobak"){echo "diGerobak";} ?></b>

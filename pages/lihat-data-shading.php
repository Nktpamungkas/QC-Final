  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> Filter Laporan Shading</h3>
      ...
      <form method="post" enctype="multipart/form-data" name="form1" class="form-horizontal" id="form1">
        ...
        <div class="box-footer">
          ...
          <div class="pull-right">
            <input type="button" class="btn btn-block btn-social btn-linkedin btn-sm" <?php if($_SESSION['lvl_id']=="AFTERSALES"){echo "disabled";}?> name="lihat" value="Kembali" onClick="window.location.href='InputLapShading'">	   
          </div>
        </div>
        <!-- /.box-footer -->
      </form>
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Data Laporan Shading</h3><br>
        <?php if($_POST['awal']!="") { ?><b>Periode: <?php echo $_POST['awal']." to ".$_POST['akhir']; ?></b>
        <?php } ?>
        <div class="pull-right">
          <a href="pages/cetak/cetak-reports-shading.php?awal=<?php echo $_POST['awal']; ?>&akhir=<?php echo $_POST['akhir']; ?>&jam_awal=<?php echo $_POST['jam_awal']; ?>&jam_akhir=<?php echo $_POST['jam_akhir']; ?>&langganan=<?php echo $_POST['langganan']; ?>&no_po=<?php echo $_POST['no_po']; ?>&no_order=<?php echo $_POST['no_order']; ?>&warna=<?php echo $_POST['warna']; ?>&no_item=<?php echo $_POST['no_item']; ?>&no_hanger=<?php echo $_POST['no_hanger']; ?>&shift=<?php echo  $GShift1; ?>" class="btn btn-primary <?php if($_POST['awal']=="") { echo "disabled"; }?>" target="_blank">Cetak</a> 
        </div>
      </div>
      <div class="box-body">
        <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
          <thead class="bg-blue">
            <tr>
              ...
              <th rowspan="2"><div align="center">Group Shift</div></th>
              ...
              <th rowspan="2"><div align="center">Qty Bruto</div></th>
              <th rowspan="2"><div align="center">Roll Cek Shading</div></th>
              <th rowspan="2"><div align="center">Oke</div></th>
              <th rowspan="2"><div align="center">%</div></th>
              <th rowspan="2"><div align="center">Reject</div></th>
              <th rowspan="2"><div align="center">%</div></th>
              <th rowspan="2"><div align="center">Roll Oke</div></th>
              <th rowspan="2"><div align="center">Roll Reject</div></th>
              <th colspan="8"><div align="center">Greyscale</div></th>
              <th rowspan="2"><div align="center">Operator</div></th>
              <th rowspan="2"><div align="center">Disposisi</div></th>
              <th rowspan="2"><div align="center">Review</div></th>
              <th rowspan="2"><div align="center">Remark</div></th>
              <th rowspan="2"><div align="center">No Prod. Order</div></th>
              <th rowspan="2"><div align="center">No Demand</div></th>
              <th rowspan="2"><div align="center">Comment</div></th>
            </tr>
            <tr>
              <th><div align="center">3</div></th>
              <th><div align="center">Ket (3)</div></th>
              <th><div align="center">3.5</div></th>
              <th><div align="center">Ket (3.5)</div></th>
              <th><div align="center">4</div></th>
              <th><div align="center">Ket (4)</div></th>
              <th><div align="center">4.5</div></th>
              <th><div align="center">Ket (4.5)</div></th>
            </tr>
          </thead>
          <tbody>
          <?php
          ...
          ?>
            <tr bgcolor="<?php echo $bgcolor; ?>">
              ...
              <td align="center"><?php echo $row1['roll_ok'];?></td>
              <td align="center"><?php if($row1['roll_inspek']!=0){echo number_format(($row1['roll_ok']/$row1['roll_inspek'])*100,2);}else{echo "0.00";}?></td>
              <td align="center"><?php echo $row1['roll_reject'];?></td>
              <td align="center"><?php if($row1['roll_inspek']!=0){echo number_format(($row1['roll_reject']/$row1['roll_inspek'])*100,2);}else{echo "0.00";}?></td>
              <td align="center"><?php echo $row1['ket_roll_ok'] ?></td>
              <td align="center"><?php echo $row1['ket_roll_reject'] ?></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['roll_gs3'] ?>" class="roll_gs3" href="javascipt:void(0)"><?php echo $row1['roll_gs3'] ?></a></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['ket_roll_gs3'] ?>" class="ket_roll_gs3" href="javascipt:void(0)"><?php echo $row1['ket_roll_gs3'] ?></a></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['roll_gs3_5'] ?>" class="roll_gs3_5" href="javascipt:void(0)"><?php echo $row1['roll_gs3_5'] ?></a></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['ket_roll_gs3_5'] ?>" class="ket_roll_gs3_5" href="javascipt:void(0)"><?php echo $row1['ket_roll_gs3_5'] ?></a></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['roll_gs4'] ?>" class="roll_gs4" href="javascipt:void(0)"><?php echo $row1['roll_gs4'] ?></a></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['ket_roll_gs4'] ?>" class="ket_roll_gs4" href="javascipt:void(0)"><?php echo $row1['ket_roll_gs4'] ?></a></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['roll_gs4_5'] ?>" class="roll_gs4_5" href="javascipt:void(0)"><?php echo $row1['roll_gs4_5'] ?></a></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['ket_roll_gs4_5'] ?>" class="ket_roll_gs4_5" href="javascipt:void(0)"><?php echo $row1['ket_roll_gs4_5'] ?></a></td>
              <td align="center"><?php echo $row1['operator'] ?></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['disposisi'] ?>" class="disposisi_shading" href="javascipt:void(0)"><?php echo $row1['disposisi'] ?></a></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['review'] ?>" class="review_shading" href="javascipt:void(0)"><?php echo $row1['review'] ?></a></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['remark'] ?>" class="remark_shading" href="javascipt:void(0)"><?php echo $row1['remark'] ?></a></td>
              <td align="center"><?php echo $row1['prod_order'] ?></td>
              <td align="center"><?php echo $row1['demand'] ?></td>
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['comment'] ?>" class="comment_shading" href="javascipt:void(0)"><?php echo $row1['comment'] ?></a></td>
            </tr>
          <?php	$no++;  } ?>
          </tbody>
        </table>

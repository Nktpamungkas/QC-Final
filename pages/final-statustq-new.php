  ...
  <!--<a href="FormKK" class="btn btn-success <?php if($_SESSION['levelPpc']=="biasa"){ echo "disabled";} ?>"><i class="fa fa-plus-circle"></i> Tambah</a>-->
      ...
      while($rowd=mysqli_fetch_array($sqldt)){
         ...
         <tr>
                  ...
                  <td align="center" >
                  <?php if($rowd['status']=="Approve"){?> <span class='badge bg-green disposisi_fail' id="<?php echo $rowd['idkk']; ?>"><?php echo $rowd['status'];?></span>  <?php }?>
                  <?php if($rowd['status']=="Conditional Approve"){?> <span class='badge bg-blue disposisi_fail' id="<?php echo $rowd['idkk']; ?>"><?php echo $rowd['status'];?></span>  <?php }?>
                  <?php if($rowd['status']=="Limit Approve"){?> <span class='badge bg-orange disposisi_fail' id="<?php echo $rowd['idkk']; ?>"><?php echo $rowd['status'];?></span>  <?php }?>
                  <?php if($rowd['status']=="Reject"){?> <span class='badge bg-red disposisi_fail' id="<?php echo $rowd['idkk']; ?>"><?php echo $rowd['status'];?></span>  <?php }?>
...
<div id="DisposisiFailTQ" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<script>

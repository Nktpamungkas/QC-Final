...
<div class="box box-info">
   	<div class="box-header with-border">
    	<h3 class="box-title">Testing Operan Kartu Kerja</h3>
                  ...
                  <label for="no_po" class="col-sm-3 control-label">No KK</label>
                  	<div class="col-sm-4">
						<div class="input-group">	  
							...
							onchange="window.location='TestingOperan-'+this.value" value="<?php if($_GET['nokk']!=""){echo $_GET['nokk'];}else{echo $nokk_post;}?>" placeholder="No KK" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>	  
		  			</div>
            </div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					onchange="window.location='TestingOperanNoTes-'+this.value" value="<?php if($cek>0){echo $rcek['no_test'];}else{echo $_GET['no_test'];} ?>" >
				</div>				   
			</div>
	        <div class="form-group">
...
if($_POST['physical_save']=="save" AND $cekNew>0){
	...
	$sqlPHYDI=mysqli_query($con,"INSERT INTO tbl_tq_disptest SET 	
		...
		if (result.value) {
			...
			window.location.href='TestingOperan-$nokk'; 
		}
		});</script>";
	}
...
if($nokk!="" and $cek==0){
  ...
  if (result.value) {
	 ...
	 window.location.href='TestingOperan'; 
  }
});</script>";
}
?>

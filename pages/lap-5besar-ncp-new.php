...
<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title"> Filter Laporan 5 Besar NCP <span class="pull-right-container">
    ...
    <div class="box">
      <div class="box-header with-border">
            ...
            <div class="pull-right">
                <a href="pages/cetak/cetak_6bulan_ncp_new_new.php?awalp1=<?php echo $_POST['awalp1']; ?>&akhirp1=<?php echo $_POST['akhirp1']; ?>&awalp2=<?php echo $_POST['awalp2']; ?>&akhirp2=<?php echo $_POST['akhirp2']; ?>&prodye=<?php echo $_POST['prodye']; ?>&probrs=<?php echo $_POST['probrs']; ?>&proprt=<?php echo $_POST['proprt']; ?>&prodye1=<?php echo $_POST['prodye1']; ?>&probrs1=<?php echo $_POST['probrs1']; ?>&proprt1=<?php echo $_POST['proprt1']; ?>" class="btn btn-success <?php if($_POST['awalp1']=="" OR $_POST['awalp2']=="") { echo "disabled"; }?>" target="_blank">Cetak Laporan 6 Bulanan NCP</a> 
                <a href="pages/cetak/cetak_bulanan_ncp_new.php?awalp1=<?php echo $_POST['awalp1']; ?>&akhirp1=<?php echo $_POST['akhirp1']; ?>&prodye=<?php echo $_POST['prodye']; ?>&total=<?php echo $_POST['total']; ?>" class="btn btn-success <?php if(($_POST['awalp2']!="" AND $_POST['akhirp2']!="") OR $_POST['awalp1']=="") { echo "disabled"; }?>" target="_blank">Cetak Laporan 5 Besar Bulanan NCP</a> 
                <a href="pages/cetak/cetak_lampiran_ncp1_new.php?awalp1=<?php echo $_POST['awalp1']; ?>&akhirp1=<?php echo $_POST['akhirp1']; ?>&prodye=<?php echo $_POST['prodye']; ?>" class="btn btn-success <?php if(($_POST['awalp2']!="" AND $_POST['akhirp2']!="") OR $_POST['awalp1']=="") { echo "disabled"; }?>" target="_blank">Lampiran 1 Laporan 5 Besar Bulanan NCP</a> 
                <a href="pages/cetak/cetak_lampiran_ncp2_new.php?awalp1=<?php echo $_POST['awalp1']; ?>&akhirp1=<?php echo $_POST['akhirp1']; ?>&prodye=<?php echo $_POST['prodye']; ?>" class="btn btn-success <?php if(($_POST['awalp2']!="" AND $_POST['akhirp2']!="") OR $_POST['awalp1']=="") { echo "disabled"; }?>" target="_blank">Lampiran 2 Laporan 5 Besar Bulanan NCP</a> 
            </div>
      </div>
      <div class="box-body">

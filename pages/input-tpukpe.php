...
$sql = "SELECT no_tpukpe FROM tbl_tpukpe WHERE SUBSTR(no_tpukpe,-2) like '%".$tahun."%' ORDER BY no_tpukpe DESC LIMIT 1";
...
$nomorbaru = $kode.$nomor;
	...
	if(isset($_POST['save'])){
		...
		$qry1=mysqli_query($con,"INSERT INTO tbl_tpukpe SET
		`id_nsp`='$_GET[id]',
		`no_tpukpe`='$no_tpukpe',
		`masalah`='$masalah',
  	...
  	<div class="col-xs-12">
    	<div class="box">
			...
			<div class="box-body">		
				...
				<tbody>
					<?php 
					$sql=mysqli_query($con,"SELECT * FROM tbl_tpukpe WHERE id_nsp='$_GET[id]' ORDER BY tgl_buat ASC");

...
<div class="box box-info collapsed-box">
  <div class="box-header with-border">
    <h3 class="box-title">Filter Tgl Target NCP&nbsp;<span class="pull-right-container">
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Laporan Pencapaian NCP&nbsp;<span class="pull-right-container">
              <small class="label pull-right bg-green blink_me">new</small>
            </span></h3>
		<div class="btn-group pull-right"> 
		<a href="pages/cetak/lap_pencapaian_new_excel.php?awal=<?php echo $Awal; ?>&akhir=<?php echo $Akhir; ?>&dept=<?php echo $Dept; ?>" class="btn btn-danger" target="_blank"><i class="fa fa-file-excel-o"> </i> Cetak</a>  
    <a href="pages/cetak/lap_pencapaian_bs_new_excel.php?awal=<?php echo $Awal; ?>&akhir=<?php echo $Akhir; ?>&dept=<?php echo $Dept; ?>" class="btn btn-success" target="_blank"><i class="fa fa-file-excel-o"> </i> Excel</a> 
		</div> 	
	  </div>
      <div class="box-body">
	...
	FROM tbl_ncp_qcf_new WHERE date_format(tgl_rencana,'%Y-%m-%d') between '$Awal' and '$Akhir' ".$where1." ORDER BY date_format(tgl_rencana,'%Y-%m-%d') ASC");
		...
		$r1=mysqli_fetch_array($sql);
		 ...
		 ?>
          <tr bgcolor="<?php echo $bgcolor; ?>">
			...
			<td align="center"><font size="-1"><?php echo $row1['no_order'];?></font><br><span class="label label-danger"><?php echo $row1['no_ncp_gabungan'];?></span><?php if($r1['tgl_terima']=="" and $r1['jml']>0){ ?><a href="#" class="btn terima_ncp_lama" id="<?php echo $r1['id']; ?>"><span class="label label-success">NCP Lama</span></a><?php } ?></td>

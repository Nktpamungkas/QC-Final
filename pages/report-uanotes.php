...
$sqlStyle=sqlsrv_query($conn,"select top 1
      ...
      dbo.fn_StockMovementDetails_GetTotalRollPCC(0, x.PCBID) as RollCount
		from
			...
			where pcb.DocumentNo='$rcek[nokk]' and pcb.Gross<>'0'
				group by
...
<div class="box box-info">
	 	...
	 	<div class="col-md-6">
                  ...
                  <label for="no_po" class="col-sm-3 control-label">No KK</label>
                  	<div class="col-sm-4">
						<div class="input-group">	  
							...
							onchange="window.location='ReportUA-'+this.value" value="<?php if($cek>0){echo $rcek['nokk'];}else{echo $_GET['nokk'];} ?>" placeholder="No KK" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>	  
		  			</div>
            </div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					onchange="window.location='ReportUANoTes-'+this.value" value="<?php if($_GET['notest']!=""){echo $_GET['notest'];}else{echo $notes_post;}?>" >
				</div>				   
			</div>
	        <div class="form-group">
            ...
            <div class="form-group">
				...
				<input name="no_rptua" type="text" class="form-control" id="no_rptua" placeholder="Report No" readonly
                    value="<?php if($notes!="" AND ($rcek['no_rptua']=="" OR $rcek['no_rptua']==NULL)){echo autono_report(); }else if($notes!="" AND $rcek['no_rptua']!=""){echo 'INDO-'.$rcek['season'].$uaproduct.$rcek['no_hanger'].'-'.$rcek['warna'].'-'.$rcek['no_rptua'];}else{echo $ReportUA;} ?>">
                	<!-- <input name="no_rptua" type="text" class="form-control" id="no_rptua" placeholder="Report No" 
                    value="<?php if($rcek['no_rptua']!=""){echo $rcek['no_rptua'];}else{echo $ReportUA;} ?>"> -->
                </div>
            </div>
            <div class="form-group">
	...
	?>
   	<div class="box-footer"> 
		...
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'BFT20081') !== false){?> 
			<a href="pages/cetak/cetak_report_ua_bft20081.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a>
...
`tgl_update`=now()");
		...
		if (result.value) {
			...
			window.location.href='ReportUANoTes-$notes'; 
		}
		});</script>";
	}
...
if($nokk!="" and $cek==0){
  ...
  if (result.value) {
	 ...
	 window.location.href='ReportUANoTes'; 
  }
});</script>";
}
?>

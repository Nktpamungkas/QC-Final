...
$qry=mysqli_query($con,"SELECT a.*, a.id AS idkk, b.* From tbl_tq_nokk a INNER JOIN tbl_master_test b ON a.no_test=b.no_testmaster WHERE nokk='$nokk' ORDER BY a.id DESC LIMIT 1");
    ...
    <div class="box-body"> 
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input name="no_test" type="text" class="form-control" id="no_test" onchange="window.location='SummaryTQNew-'+this.value" 
                    value="<?php if($cekd>0){echo $rd['no_test'];}else {echo $_GET['no_test'];}?>" placeholder="No Test" required>
                </div>
            </div> 
            <div class="form-group">
                <label for="nokk" class="col-sm-3 control-label">No KK</label>
                <div class="col-sm-5">
                    <input name="nokk" type="text" class="form-control" id="nokk" placeholder="No KK" value="<?php echo $_GET['nokk'];?>" onchange="window.location='SummaryTQNokkNew-'+this.value" required>
                </div>				   
            </div>
            <div class="form-group">
                  ...
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-hover table-striped" width="100%"> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("CURLING",$detail)){echo "CURLING";} ?></a></td>
                                <td align="center" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="status" class="form-control select2" id="status" style="width: 100%;" <?php if($rcek1['status']!='' AND $_SESSION['nama1']!='Janu Dwi Laksono'){echo "disabled";}?>>
                                    ...
                                    <?php if($Fla=="False" XOR $Fc=="False" XOR $Bsk=="False" XOR $Pm=="False" XOR $Pl=="False" XOR $Fwss=="False" XOR 
                                    $Pb=="False" XOR $Prt=="False" XOR $Abr=="False" XOR $Sm=="False" XOR $Sp=="False" XOR $Sb=="False" XOR $Bs2=="False" XOR $Sr=="False" XOR 
                                    $Gr=="False" XOR $Ap=="False" XOR $Hs=="False" XOR $Ff=="False" XOR $Odo=="False" XOR $Wic=="False" XOR $Abs=="False" XOR $Dry=="False" XOR $Wp=="False" XOR 
                                    $Ph=="False" XOR $Sor=="False" XOR $Hum=="False" XOR $Wf=="False" XOR $Pac=="False" XOR $Pal=="False" XOR $Wtr=="False" XOR $Cr=="False" XOR $Py=="False" XOR $Lg=="False" XOR 
                                    $Cmo=="False" XOR $Cm=="False" XOR $Lp=="False" XOR $Slv=="False" XOR $Bld=="False" XOR $Chl=="False" XOR $Nchl=="False" XOR $Dye=="False"){}else{?>
...
if($_POST['status_save']=="save" and $_POST['status']==""){
  echo "<script>swal({
    ...
    if (result.value) {
     ...
     window.location.href='SummaryTQNokkNew-$nokk'; 
    }
  });</script>";
...
if($nokk!="" and $cekd==0){
 ...
 if (result.value) {
    ...
    window.location.href='SummaryTQNokkNew'; 
 }
});</script>";
}
?>
		...
		<div class="box-body">
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input name="nokk" type="text" class="form-control" id="nokk" onchange="window.location='NCP-'+this.value" value="<?php echo $_GET['nokk']; ?>" placeholder="No KK" required>
					</div>
				</div>
				<div class="form-group">
						...
						<div class="input-group">
							<select name="no_ncp" class="form-control" id="no_ncp" placeholder="No NCP" onChange="rd();">
								...
								while ($dCek = mysqli_fetch_array($qCek)) { ?>
									<option value="<?php echo $dCek['no_ncp']; ?>" <?php if ($dCek['no_ncp'] == $NCPNO) {
																						echo "SELECTED";

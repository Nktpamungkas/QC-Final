        ...
        <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
          ...
          <?php
            ...
            if($Awal!="" or $Langganan!="" or $Item!="" or $Hanger!="" or $Warna!="" or $PO!="" or $Order!=""){
              $qry1=mysqli_query($con,"SELECT * FROM tbl_lap_shading WHERE DATE_FORMAT( tgl_update, '%Y-%m-%d %H:%i' ) BETWEEN '$start_date' AND '$stop_date' $lgn $noitem $nohanger $wn $nopo $noorder ORDER BY id ASC");
            }else{
              $qry1=mysqli_query($con,"SELECT * FROM tbl_lap_shading WHERE DATE_FORMAT( tgl_update, '%Y-%m-%d %H:%i' ) BETWEEN '$start_date' AND '$stop_date' $lgn $noitem $nohanger $wn $nopo $noorder ORDER BY id ASC");
            }
          ...
          ?>
            <tr bgcolor="<?php echo $bgcolor; ?>">
              ...
              <td align="center"><?php echo $row1['roll_gs3'] ?></td>
              <td align="center"><?php echo $row1['ket_roll_gs3'] ?></td>
              <td align="center"><?php echo $row1['roll_gs3_5'] ?></td>
              <td align="center"><?php echo $row1['ket_roll_gs3_5'] ?></td>
              <td align="center"><?php echo $row1['roll_gs4'] ?></td>
              <td align="center"><?php echo $row1['ket_roll_gs4'] ?></td>
              <td align="center"><?php echo $row1['roll_gs4_5'] ?></td>
              <td align="center"><?php echo $row1['ket_roll_gs4_5'] ?></td>

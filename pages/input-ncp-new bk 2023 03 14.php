	 ...
	 <div class="col-md-5"> 
		<div class="form-group">
					  ...
					  <input name="nokk" type="text" class="form-control" id="nokk" 
						 onchange="window.location='NCPNew-'+this.value" value="<?php echo $_GET['nokk'];?>" placeholder="No KK" required >
			  </div>
			<?php if($nokk){ ?>
	  ...
	  <div class="form-group">
		  <label for="no_ncp" class="col-sm-3 control-label">Kk Salinan</label>
			...
			<input name="kksalinan" type="text" class="form-control" id="kksalinan" 
				   onchange="window.location='NCPNew-<?php echo $nokk;?>-'+this.value"
	  ...
	  <div class="form-group">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-2">
			<input name="lot_salinan" type="text" class="form-control" id="lot" 
			value="<?php if($cek>0){echo $rcek['lot_salinan'];}else{echo $lotnoS;} ?>" placeholder="Lot" readonly >
		  </div>			  
		  <div class="col-sm-4">
		  <div class="input-group">	  
		...
		<div class="form-group">
		  	...
		  	<div class="col-sm-6">				
			<input name="masalah_tambahan" type="text" class="form-control" id="masalah_tambahan" 
			value="<?php if($cek>0){echo $rcek['masalah_tambahan'];} ?>" placeholder="Penyebab Tambahan" >				
			</div>	

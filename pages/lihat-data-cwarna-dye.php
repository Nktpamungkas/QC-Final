    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header with-border">
          ...
          <?php } ?>
          <div class="pull-right">
            <a href="pages/cetak/cetak-reports-cocok-warna-dye.php?awal=<?php echo $_POST['awal']; ?>&akhir=<?php echo $_POST['akhir']; ?>&shift=<?php echo $_POST['gshift']; ?>" class="btn btn-primary <?php if ($_POST['awal'] == "") {
                                                                                                                                                                                                            echo "disabled";
                                                                                                                                                                                                          } ?>" target="_blank">Cetak</a>
            <a href="pages/cetak/lap-cocok-warna-dye-excel.php?awal=<?php echo $_POST['awal']; ?>&akhir=<?php echo $_POST['akhir']; ?>&shift=<?php echo $_POST['gshift']; ?>" class="btn btn-primary <?php if ($_POST['awal'] == "") {
                                                                                                                                                                                                        echo "disabled";
          ...
          <table class="table table-bordered table-hover table-striped nowrap" id="example1" style="width:100%">
            <thead class="bg-blue">
              <tr>
                ...
                <th>
                  <div align="center">No Barcode</div>
                </th>
                <th>
                ...
                <th>
                  <div align="center">Demand ERP</div>
                </th>
                <th>
                  <div align="center">Prod. Order ERP</div>
                </th>
                <th>
            ...
            <tbody>
              <?php
                ...
                if ($Awal != "" and $Akhir != "") {
                  $where = " AND DATE_FORMAT( tgl_celup, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' ";
                } else {
                  $where = " ";
                }
                if ($Awal != "" and $Akhir != "") {
              ...
              ?>
                <tr bgcolor="<?php echo $bgcolor; ?>">
                  ...
                  <td align="center">
                    <div class="btn-group">
                      <!--<a href="#" class="btn btn-info btn-xs cwarnadye_edit <?php if ($_SESSION['akses'] == 'biasa' and ($_SESSION['lvl_id'] != 'PACKING' or $_SESSION['lvl_id'] != 'NCP')) {
                                                                                  echo "disabled";
                      ...
                      <a href="#" class="btn btn-danger btn-xs <?php if ($_SESSION['akses'] == 'biasa' and ($_SESSION['lvl_id'] != 'PACKING' or $_SESSION['lvl_id'] != 'NCP')) {
                                                                  echo "disabled";
                                                                } ?>" onclick="confirm_delete('./HapusDataCWarnaDye-<?php echo $row1['id'] ?>');"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Hapus"></i> </a>
                    </div>
                  </td>

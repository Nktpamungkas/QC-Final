...
$qry=mysqli_query($con,"SELECT a.*, a.id AS idkk, b.* From tbl_tq_nokk a INNER JOIN tbl_master_test b ON a.no_test=b.no_testmaster WHERE no_test='$no_test'");
    ...
    <div class="box-body"> 
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input name="nokk" type="text" class="form-control" id="nokk" placeholder="No KK" value="<?php if($cekd>0){echo $rd['nokk'];}else {echo $_GET['nokk'];}?>" onchange="window.location='SummaryTQNokkNew-'+this.value" required>
                </div>				   
            </div>
            <div class="form-group">
...
if($_POST['status_save']=="save" and $_POST['status']==""){
  echo "<script>swal({
    ...
    if (result.value) {
     ...
     window.location.href='SummaryTQNew-$no_test'; 
    }
  });</script>";
...
if($no_test!="" and $cekd==0){
 ...
 if (result.value) {
    ...
    window.location.href='SummaryTQNew'; 
 }
});</script>";
}
?>
...
$sqlCek=mysqli_query($con,"SELECT * FROM tbl_tq_nokk WHERE nokk='$nokk' and no_test='$notest' ORDER BY id DESC LIMIT 1");
  ...
  <div class="box-body"> 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
            ...
            onchange="window.location='ResultKKNew-'+this.value" onBlur="window.location='ResultKKNew-'+this.value" value="<?php echo $_GET['nokk'];?>" placeholder="No KK" required >
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
			    ...
			    <?php $qryNoTes=mysqli_query($con,"SELECT no_test FROM tbl_tq_nokk WHERE nokk='$nokk' ORDER BY no_test DESC");
				  while($r=mysqli_fetch_array($qryNoTes)){?>
...
<div class="modal fade modal-3d-slit" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" style="width:90%">
		<div class="modal-content">
            ...
            $sql = mysqli_query($con,"SELECT a.* FROM tbl_tq_nokk a INNER JOIN tbl_tq_test b ON a.id=b.id_nokk WHERE DATE_FORMAT( a.tgl_masuk, '%Y' )!='2019' and DATE_FORMAT( a.tgl_masuk, '%Y' )!='2020'");
            $no="1";

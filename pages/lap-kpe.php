...
<div class="box">
  ...
  <form method="post" enctype="multipart/form-data" name="form1" class="form-horizontal" id="form1">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
        <input type="checkbox" name="sts_red" id="sts_red" value="1" <?php  if($sts_red=="1"){ echo "checked";} ?> <?php if($_SESSION['lvl_id']!='AFTERSALES'){ echo "disabled"; } ?>>  
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3">
        <input type="checkbox" name="sts_claim" id="sts_claim" value="1" <?php  if($sts_claim=="1"){ echo "checked";} ?> <?php if($_SESSION['lvl_id']!='AFTERSALES'){ echo "disabled"; } ?>>  
        <label> Claim</label>
      ...
      <div class="box-header with-border">
        ...
        <?php if($_POST['awal']!="") { ?><b>Periode: <?php echo $_POST['awal']." to ".$_POST['akhir']; ?></b>
          ...
          <div class="pull-right">
            <a href="pages/cetak/cetak_kpe.php?awal=<?php echo $_POST['awal']; ?>&akhir=<?php echo $_POST['akhir']; ?>&order=<?php echo $_POST['order']; ?>&po=<?php echo $_POST['po']; ?>&hanger=<?php echo $_POST['hanger']; ?>&langganan=<?php echo $_POST['langganan']; ?>" class="btn btn-danger <?php if($_POST['awal']=="" OR $_SESSION['lvl_id']!='AFTERSALES' ) { echo "disabled"; }?>" target="_blank">Cetak KPE</a> 
          </div>
        <?php if($sts_red=='1'){?>
              <div class="pull-right">
                ...
                <a href="pages/cetak/excel_redemail.php?awal=<?php echo $_POST['awal']; ?>&akhir=<?php echo $_POST['akhir']; ?>" class="btn btn-success <?php if($_POST['awal']=="") { echo "disabled"; }?>" target="_blank">Excel Red Email</a>
                </div>
            <?php } ?>
        <?php if($sts_claim=='1'){?>
              <div class="pull-right">
        ...
        <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
          ...
          <?php
            ...
            if($Awal!="" or $sts_red=="1" or $sts_claim=="1" or $Order!="" or $Hanger!="" or $PO!="" or $Langganan!=""){
              ...
              FROM tbl_aftersales a LEFT JOIN tbl_ncp_qcf b ON a.nokk=b.nokk 
              WHERE a.no_order LIKE '%$Order%' AND a.po LIKE '%$PO%' AND a.no_hanger LIKE '%$Hanger%' AND a.langganan LIKE '%$Langganan%' $Where $stsred $stsclaim 
              GROUP BY a.nokk
              ORDER BY a.id ASC");
            }else{
              $qry1=mysqli_query($con,"SELECT a.*,

...
<div class="box box-info">
    ...
    <div class="box-body">
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label for="lot_erp" class="col-sm-3 control-label">Prod. Order ERP</label>
                <div class="col-sm-5">
                    <input name="lot_erp" class="form-control" type="text" id="lot_erp" value="<?php echo $row['lot_erp'];?>" placeholder="Prod. Order ERP" required>
                </div>
            </div>
            <div class="form-group">

...
$sqlStyle=sqlsrv_query($conn,"select top 1
    ...
    //     $thn= date("Y");
    //     $sqlnorptlulu = mysqli_query($con,"SELECT no_rptlulu FROM tbl_tq_nokk WHERE substr(no_rptlulu,1,10) like '%".$thn."%' ORDER BY no_rptlulu DESC LIMIT 1") or die(mysqli_error());
    //     $dt=mysqli_num_rows($sqlnorptlulu);
    //     if ($dt>0) {
    //         $rd=mysqli_fetch_array($sqlnorptlulu);
    //         $dt=$rd['no_rptlulu'];
    //         $strd=substr($dt, 10, 5);
    //         $Urutd = (int)$strd;
    //     } else {
...
<div class="box box-info">
   	<div class="box-header with-border">
    	<h3 class="box-title">Report FirstLot Lululemon</h3>
  	...
  	<div class="box-body"> 
	 	<div class="col-md-6">
                  ...
                  <label for="no_po" class="col-sm-3 control-label">No KK</label>
                  	<div class="col-sm-4">
						<div class="input-group">	  
							...
							onchange="window.location='ReportFLLululemon-'+this.value" value="<?php if($_GET['nokk']!=""){echo $_GET['nokk'];}else{echo $nokk_post;}?>" placeholder="No KK" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>	  
		  			</div>
            </div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					onchange="window.location='ReportFLLululemonNoTes-'+this.value" value="<?php if($cek>0){echo $rcek['no_test'];}else{echo $_GET['no_test'];} ?>" >
				</div>				   
			</div>
	        <div class="form-group">
            ...
            <div class="form-group">
                <label for="no_rptlulu" class="col-sm-3 control-label">Report No</label>
                <div class="col-sm-4">
                	<input name="no_rptlulu" type="text" class="form-control" id="no_rptlulu" placeholder="Report No" 
                    value="<?php if($rcek['no_rptlulu']!=""){echo $rcek['no_rptlulu'];}else{echo $ReportLulu;} ?>">
				<!-- <?php if($nokk!="" AND ($rcek['no_rptlulu']=="" OR $rcek['no_rptlulu']==NULL)){echo autono_report(); }else{echo $rcek['no_rptlulu'];} ?>  readonly="readonly" -->
                </div>
				<div class="col-sm-2">
                	<input name="revisi" type="text" class="form-control" id="revisi" placeholder="Revisi" 
                    value="<?php if($rcek['revisi']!=""){echo $rcek['revisi'];}else{echo $Revisi;} ?>">
                </div>	
				<div class="col-sm-2">
					<label><input type="checkbox" name="sts_rev" id="sts_rev" class="minimal" value="1" <?php if($rcek['sts_rev']=='1'){echo "checked";}?>> &#10003;
					</label>
				</div>				   
            </div>
            <div class="form-group">
	  	...
	  	<div class="col-md-6"> 		  
			...
			<div class="form-group">
                <label for="reject2" class="col-md-3 control-label">Upload Pilling 1</label>
                <div class="col-sm-5">	  
			...
			<div class="form-group">
                <label for="reject3" class="col-md-3 control-label">Upload Pilling 2</label>
                <div class="col-sm-5">	  
			...
			<div class="form-group">
                <label for="lf_reject" class="col-md-3 control-label">Upload LF Reject</label>
                <div class="col-sm-5">	  
                    <input type="file" id="lf_reject" name="lf_reject"><span style="color:red;"><?php if($cek>0){echo $rcek['lf_reject'];} ?></span>
                    <span class="help-block with-errors"></span>
                </div>	  
            </div>
			<div class="form-group">
                <label for="wet_crocking" class="col-md-3 control-label">Upload Wet Crocking</label>
                <div class="col-sm-5">	  
                    <input type="file" id="wet_crocking" name="wet_crocking"><span style="color:red;"><?php if($cek>0){echo $rcek['wet_crocking'];} ?></span>
                    <span class="help-block with-errors"></span>
                </div>	  
            </div>   	 	
	 	</div>
...
`tgl_update`=now()");
		...
		if (result.value) {
			...
			window.location.href='ReportFLLululemon-$nokk'; 
		}
		});</script>";
	}
...
if($nokk!="" and $cek==0){
  ...
  if (result.value) {
	 ...
	 window.location.href='ReportFLLululemon'; 
  }
});</script>";
}
?>
...
if($_POST['save1']=="save"){
	...
	$color_abb=str_replace("'","''",$Color_Abbrev);
	$fabric_fin=str_replace("'","''",$Fabric_Finish);
	$revisi=str_replace("'","''",$Revisi);
	$date_in=$DateIn;
	...
	$file_wet_crocking = $_FILES['wet_crocking']['name'];
	// ambil data file
	...
	$namaFile_lf_reject = $_FILES['lf_reject']['name'];
	$namaSementara_lf_reject = $_FILES['lf_reject']['tmp_name'];
	$namaFile_wet_crocking = $_FILES['wet_crocking']['name'];
	$namaSementara_wet_crocking = $_FILES['wet_crocking']['tmp_name'];
	// tentukan lokasi file akan dipindahkan
	$dirUpload = "dist/img-rptlulu/";
	// pindahkan file
	...
	`revisi`='$Revisi',
	`sts_rev`='$_POST[sts_rev]',
	`date_out`='$date_out',
	`style`='$sty',
	`jenis_kain`='$jenis_kain',
	`tgl_kirim`='$TglKirim',
	`prev_report`='$prev',
	`color_abbrev`='$color_abb',
	`season`='$Season',
	`date_in`='$date_in',

...
$Hitung		= isset($_POST['chkhitung']) ? $_POST['chkhitung'] : '';
...
#container5 {
  ...
  <body>
        ...
        <div class="box-header with-border">
            <h3 class="box-title">Filter Data <span class="pull-right-container">
        ...
        <form method="post" enctype="multipart/form-data" name="form1" class="form-horizontal" id="form1">
            ...
            <div class="form-group">
				...
				<div class="col-sm-2">
              	<label>
                <input type="checkbox" value="1" name="chkhitung" class="minimal-red" <?php if($Hitung=="1"){ echo "checked";}?>>
                  Tampil NCP Hitung
              	</label>
            	</div>
                <!-- <div class="col-sm-2">
    ...
    <div class="row">
        <div class="col-xs-6">	
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"> 3 Terbesar Masalah Per Item NCP <?php echo $Nhitung; ?>: <?php echo $tglAw." s/d ".$tglAk;?></h3>
                    <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    </div>
                </div>
                ...
                <div class="box-footer">
                        <a href="pages/cetak/excel_3besar_masalah_ncp_item_new.php?awal=<?php echo $_POST['awal']; ?>&akhir=<?php echo $_POST['akhir']; ?>&hitung=<?php echo $Hitung; ?>" class="btn btn-success <?php if($_POST['awal']=="") { echo "disabled"; }?>" target="_blank"><i class="fa fa-file-excel-o"></i></a> 
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xs-6">	
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"> 3 Terbesar Item NCP <?php echo $Nhitung; ?>: <?php echo $tglAw." s/d ".$tglAk;?></h3>
                    <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    </div>
                </div>
                ...
                <table class="table table-bordered table-striped" style="width: 100%;">
                        ...
                        (SELECT no_item, no_hanger, SUM(berat) AS qty_kg FROM tbl_ncp_qcf_new WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' $wHitung1
                        GROUP BY no_item
                        ORDER BY qty_kg DESC
                        LIMIT 3) a");
                        $rt3=mysqli_fetch_array($qryt3);
                        $qrytall=mysqli_query($con,"SELECT SUM(berat) AS qty_kg_all FROM tbl_ncp_qcf_new WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' $wHitung1 ");
                        ...
                        WHERE DATE_FORMAT(a.tgl_update, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND b.status='selesai' and b.proses ='Celup Greige' and not b.ket_status =''");
                ...
                <div class="box-footer">
                        <a href="pages/cetak/excel_3besar_ncp_item_new.php?awal=<?php echo $_POST['awal']; ?>&akhir=<?php echo $_POST['akhir']; ?>&hitung=<?php echo $Hitung; ?>" class="btn btn-success <?php if($_POST['awal']=="") { echo "disabled"; }?>" target="_blank"><i class="fa fa-file-excel-o"></i></a>
                    </div>
                </div>
            </div>
        </div>

<script type="text/javascript">
    function proses_nokk(){
        ...
        if (nokk == 0) {
            window.location.href='InputLapShading';
        }else{
            window.location.href='InputLapShading&'+nokk;
        }
    }
    ...
    function proses_shift() {
        ...
        if (nokk == "") {
            ...
            window.location.href='InputLapShading&'+nokk+'&'+shift;
        }
    }
</script>
<?php
...
{
	$ceksql=mysqli_query($con,"SELECT * FROM `tbl_lap_shading` WHERE `nokk`='$_GET[nokk]' and `shift`='$_POST[shift]' AND DATE_FORMAT(tgl_update, '%Y-%m-%d') = DATE_FORMAT(now(), '%Y-%m-%d') LIMIT 1");
	...
	if($sql1){
        ...
        echo "<script>swal({
            ...
            if (result.value) {
                window.location.href='InputLapShading&$_POST[nokk]';
...
$msql=mysqli_query($con,"SELECT * FROM `tbl_lap_shading` WHERE `nokk`='$nokk' and `shift`='$_GET[shift]' AND DATE_FORMAT(tgl_update, '%Y-%m-%d') = DATE_FORMAT(now(), '%Y-%m-%d')");
$row=mysqli_fetch_array($msql);
$crow=mysqli_num_rows($msql);

//Data sudah disimpan di database mysqli
$msql1=mysqli_query($con,"SELECT * FROM `tbl_lap_shading` WHERE `nokk`='$nokk' and `shift`='$_GET[shift]' ");
$row1=mysqli_fetch_array($msql1);
$crow1=mysqli_num_rows($msql1);

//Data sudah disimpan di database mysqli
$qryfin=mysqli_query($con,"SELECT * FROM `tbl_lap_shading` WHERE `nokk`='$nokk' ORDER BY id DESC");
...
<div class="box box-info">
    ...
    <div class="box-body">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label for="roll_ok" class="col-sm-3 control-label">OK</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input name="roll_ok" type="text" class="form-control" id="roll_ok" value="<?php if($crow>0){echo $row['roll_ok'];}?>" placeholder="" required>
                        <span class="input-group-addon">Roll</span>
					</div>
                </div>
            </div>
            <div class="form-group">
                <label for="roll_reject" class="col-sm-3 control-label">Reject</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input name="roll_reject" type="text" class="form-control" id="roll_reject" value="<?php if($crow>0){echo $row['roll_reject'];}?>" placeholder="" required>
                        <span class="input-group-addon">Roll</span>
					</div>
                </div>
                <div class="col-sm-3">
                    <input name="ket_roll_reject" type="text" class="form-control" id="ket_roll_reject" value="<?php if($crow>0){echo $row['ket_roll_reject'];} ?>" placeholder="Masukkan Roll" required>
				</div>
            </div>
            <!-- <div class="form-group">
                <label for="roll_gs2" class="col-sm-3 control-label">2</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input name="roll_gs2" type="text" class="form-control" id="roll_gs2" value="<?php if($crow>0){echo $row['roll_gs2'];}?>" placeholder="" >
                        <span class="input-group-addon">Roll</span>
					</div>
                </div>
                <div class="col-sm-3">
                    <input name="ket_roll_gs2" type="text" class="form-control" id="ket_roll_gs2" value="<?php if($crow>0){echo $row['ket_roll_gs2'];} ?>" placeholder="Masukkan Roll">
				</div>
            </div>
            <div class="form-group">
                <label for="roll_gs2_5" class="col-sm-3 control-label">2.5</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input name="roll_gs2_5" type="text" class="form-control" id="roll_gs2_5" value="<?php if($crow>0){echo $row['roll_gs2_5'];}?>" placeholder="" >
                        <span class="input-group-addon">Roll</span>
					</div>
                </div>
                <div class="col-sm-3">
                    <input name="ket_roll_gs2_5" type="text" class="form-control" id="ket_roll_gs2_5" value="<?php if($crow>0){echo $row['ket_roll_gs2_5'];} ?>" placeholder="Masukkan Roll">
				</div>
            </div> -->
            <div class="form-group">
                <label for="roll_gs3" class="col-sm-3 control-label">3</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input name="roll_gs3" type="text" class="form-control" id="roll_gs3" value="<?php if($crow>0){echo $row['roll_gs3'];}?>" placeholder="" >
                        <span class="input-group-addon">Roll</span>
					</div>
                </div>
                <div class="col-sm-3">
                    <input name="ket_roll_gs3" type="text" class="form-control" id="ket_roll_gs3" value="<?php if($crow>0){echo $row['ket_roll_gs3'];} ?>" placeholder="Masukkan Roll">
				</div>
            </div>
            <div class="form-group">
                <label for="roll_gs3_5" class="col-sm-3 control-label">3.5</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input name="roll_gs3_5" type="text" class="form-control" id="roll_gs3_5" value="<?php if($crow>0){echo $row['roll_gs3_5'];}?>" placeholder="" >
                        <span class="input-group-addon">Roll</span>
					</div>
                </div>
                <div class="col-sm-3">
                    <input name="ket_roll_gs3_5" type="text" class="form-control" id="ket_roll_gs3_5" value="<?php if($crow>0){echo $row['ket_roll_gs3_5'];} ?>" placeholder="Masukkan Roll">
				</div>
            </div>
            <div class="form-group">
                <label for="roll_gs4" class="col-sm-3 control-label">4</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input name="roll_gs4" type="text" class="form-control" id="roll_gs4" value="<?php if($crow>0){echo $row['roll_gs4'];}?>" placeholder="" >
                        <span class="input-group-addon">Roll</span>
					</div>
                </div>
                <div class="col-sm-3">
                    <input name="ket_roll_gs4" type="text" class="form-control" id="ket_roll_gs4" value="<?php if($crow>0){echo $row['ket_roll_gs4'];} ?>" placeholder="Masukkan Roll">
				</div>
            </div>
            <div class="form-group">
                <label for="roll_gs4_5" class="col-sm-3 control-label">4.5</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input name="roll_gs4_5" type="text" class="form-control" id="roll_gs4_5" value="<?php if($crow>0){echo $row['roll_gs4_5'];}?>" placeholder="" >
                        <span class="input-group-addon">Roll</span>
					</div>
                </div>
                <div class="col-sm-3">
                    <input name="ket_roll_gs4_5" type="text" class="form-control" id="ket_roll_gs4_5" value="<?php if($crow>0){echo $row['ket_roll_gs4_5'];} ?>" placeholder="Masukkan Roll">
				</div>
            </div>
            <div class="form-group">
    ...
    <div class="box-footer">
            ...
            <?php } ?>
            <button type="button" class="btn btn-warning pull-left" name="lihat" value="lihat" onClick="window.location.href='LihatDataShading'"><i class="fa fa-search"></i> Lihat Data</button> 	   
    </div>
</div>
</form>

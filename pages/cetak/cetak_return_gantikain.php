            ...
            <td width="32%" align="center"><table class="table-list1" width="100%">
                <tbody>
                    ...
                    <tr>
                        ...
                        $AkhirRT=$_GET['akhirrt']; 
                        //query total adidas
                        $qryad=mysqli_query($con,"SELECT SUM(kg) as kgad FROM tbl_detail_retur 
                        ...
                        $qryll=mysqli_query($con,"SELECT SUM(kg) as kgll FROM tbl_detail_retur 
    ...
    <tr>
        <td><table border="1" class="table-list1" style="width:7.9in;">
            ...
            <?php
                $AwalGK=$_GET['awalgk'];
                $AkhirGK=$_GET['akhirgk'];
                $qry2=mysqli_query($con,"SELECT *, SUM(qty_claim) as qty_claim_lgn, SUM(kg1) as kg1_lgn FROM tbl_ganti_kain 
            ...
            <?php 
                ...
                $AkhirGK=$_GET['akhirgk']; 
                //query total adidas
                $qryad1=mysqli_query($con,"SELECT SUM(qty_claim) AS qty_claim_ad, SUM(kg1) as kg1_lgn_ad FROM tbl_ganti_kain 
                WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalGK' AND '$AkhirGK' AND langganan LIKE '%ADIDAS%' ");
                $rowad1=mysqli_fetch_array($qryad1);
                //query total Lululemon
                $qryll1=mysqli_query($con,"SELECT SUM(qty_claim) AS qty_claim_ll, SUM(kg1) as kg1_lgn_ll FROM tbl_ganti_kain

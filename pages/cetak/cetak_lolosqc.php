...
<table width="100%">
  ...
  $qry1=mysqli_query($con,"SELECT * FROM tbl_aftersales WHERE langganan LIKE '%$_GET[langganan]%' $Where $lolos $shft $subdpt ORDER BY pejabat,personil ASC");
  }else{
  $qry1=mysqli_query($con,"SELECT * FROM tbl_aftersales WHERE langganan LIKE '$_GET[langganan]' $Where $lolos $shft $subdpt ORDER BY pejabat,personil ASC");
  }
  $tkirim=0;
        ...
        <tr>
          <td style="border-top:0px #000000 solid; 
            ...
            <tr>
              <?php
              if($_GET['langganan']!=""){ $lgn =" AND langganan LIKE '%$_GET[langganan]%' "; }else{$lgn = " ";}
              $qry1=mysqli_query($con,"SELECT shift, shift2, shift3, shift4, IF(shift4!='',qty_claim/4,IF(shift3!='',qty_claim/3,IF(shift2!='',qty_claim/2,qty_claim))) AS qty_claim_a FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='A' OR shift2='A' OR shift3='A' OR shift4='A') $lgn"); 
              //DEFECT LOLOS QC
            ...
            <tr>
            <?php
              $qry2=mysqli_query($con,"SELECT shift, shift2, shift3, shift4, IF(shift4!='',qty_claim/4,IF(shift3!='',qty_claim/3,IF(shift2!='',qty_claim/2,qty_claim))) AS qty_claim_b FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='B' OR shift2='B' OR shift3='B' OR shift4='B') $lgn"); 
              //DEFECT LOLOS QC
            ...
            <tr>
            <?php
              $qry3=mysqli_query($con,"SELECT shift, shift2, shift3, shift4, IF(shift4!='',qty_claim/4,IF(shift3!='',qty_claim/3,IF(shift2!='',qty_claim/2,qty_claim))) AS qty_claim_c FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='C' OR shift2='C' OR shift3='C' OR shift4='C') $lgn"); 
              //DEFECT LOLOS QC
            ...
            <tr>
            <?php
              $qry4=mysqli_query($con,"SELECT shift, shift2, shift3, shift4, IF(shift4!='',qty_claim/4,IF(shift3!='',qty_claim/3,IF(shift2!='',qty_claim/2,qty_claim))) AS qty_claim_non FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='Non-Shift' OR shift2='Non-Shift' OR shift3='Non-Shift' OR shift4='Non-Shift') $lgn"); 
              //DEFECT LOLOS QC
            ...
            <tr>
              <?php
              $qry5=mysqli_query($con,"SELECT shift, shift2, shift3, shift4, IF(shift4!='',qty_claim/4,IF(shift3!='',qty_claim/3,IF(shift2!='',qty_claim/2,qty_claim))) AS qty_claim_qc2 FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='QC2' OR shift2='QC2' OR shift3='QC2' OR shift4='QC2') $lgn"); 
              //DEFECT LOLOS QC
              ...
              <tr>
              <?php
              $qry6=mysqli_query($con,"SELECT shift, shift2, shift3, shift4, IF(shift4!='',qty_claim/4,IF(shift3!='',qty_claim/3,IF(shift2!='',qty_claim/2,qty_claim))) AS qty_claim_tq FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='Test Quality' OR shift2='Test Quality' OR shift3='Test Quality' OR shift4='Test Quality') $lgn"); 
              //DEFECT LOLOS QC
        ...
        <tr>
          <td style="border-top:0px #000000 solid; 
            ...
            <tr>
              ...
              // (SELECT DISTINCT personil, pejabat, shift FROM tbl_aftersales WHERE
              // DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              ...
              // (SELECT personil2, shift2 FROM tbl_aftersales WHERE
              // DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              ...
              (SELECT DISTINCT personil, pejabat, shift, SUM(IF(shift4!='',qty_claim/4,IF(shift3!='',qty_claim/3,IF(shift2!='',qty_claim/2,qty_claim)))) AS qty_claim FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              ...
              (SELECT personil2, shift2, SUM(IF(shift4!='',qty_claim/4,IF(shift3!='',qty_claim/3,IF(shift2!='',qty_claim/2,qty_claim)))) AS qty_claim2 FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND personil2!='' $lgn $subdpt GROUP BY personil2, shift2 ORDER BY shift2 ASC) AS B
              UNION 
              SELECT personil3 AS personil, '' AS pejabat, shift3 AS shift, qty_claim3 AS qty_claim FROM 
              (SELECT personil3, shift3, SUM(IF(shift4!='',qty_claim/4,IF(shift3!='',qty_claim/3,IF(shift2!='',qty_claim/2,qty_claim)))) AS qty_claim3 FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              ...
              (SELECT personil4, shift4, SUM(IF(shift4!='',qty_claim/4,IF(shift3!='',qty_claim/3,IF(shift2!='',qty_claim/2,qty_claim)))) AS qty_claim4 FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              ...
              while($row1=mysqli_fetch_array($qry1)){
                //PERSONIL & PEJABAT
                $qryD=mysqli_query($con,"SELECT if(shift2!='',qty_claim/2,qty_claim) as qty_claim FROM tbl_aftersales WHERE
                DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
                ...
                //PERSONIL 2
                $qryD2=mysqli_query($con,"SELECT if(shift2!='',qty_claim/2,qty_claim) as qty_claim FROM tbl_aftersales WHERE
                DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
                ...
                $qryjml1=mysqli_query($con,"SELECT COUNT(*) as jml FROM tbl_aftersales WHERE
                DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
                ...
                $rowjml1=mysqli_fetch_array($qryjml1);
                // $qryjml2=mysqli_query($con,"SELECT COUNT(*) as jml FROM tbl_aftersales WHERE
                // DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
                // AND '$Akhir' AND sts='1' AND sts_revdis='0' AND personil2='$row1[personil]' AND shift2='$row1[shift]' $lgn $subdpt");
                // $rowjml2=mysqli_fetch_array($qryjml2);
              ?>

...
<body>
    ...
    <table width="100%" border="1" class="table-list1">
        ...
        <tbody>
            ...
            <tr>
                <td align="left" style="font-size: 12px;">PILLING RESISTANCE : CIRCULAR LOCUS</td>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            ?>
            <td align="center" style="font-size: 11px; <?php if($rcek1['f_weight']!='' AND $rcek1['f_weight'] = $batas_bawah){echo "";}else if($rcek1['f_weight']!='' AND $rcek1['f_weight'] = $batas_atas){echo "";}else if($rcek1['f_weight']!='' AND $rcek1['f_weight'] < $batas_bawah){echo "color:red;";}else if($rcek1['f_weight']!='' AND $rcek1['f_weight'] > $batas_atas){echo "color:red;";}?>" width="33%"><?php if($rcek1['stat_fwss2']=="DISPOSISI"){echo $rcekD['df_weight'];}else if($rcek1['f_weight']!=""){echo $rcek1['f_weight'];}else{echo "N/A";}?></td>
    ...
    <table width="100%">
       ...
       <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>PILLING RESISTANCE:RANDOM TUMBLE PILLING</u></strong> (UATM 017, 30 MINS)</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>PILLING RESISTANCE:RANDOM TUMBLE PILLING</u></strong> (UATM 017, 60 MINS)</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">FACE</td>
    ...
    <table width="100%">
        ...
        <!-- DYE TRANSFER BEGIN -->
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>COLORFASTNESS TO DYE TRANSFER IN STORAGE</u></strong> (UATM 008,</td>
        </tr>
        <tr>
        ...
        <!-- THERMAL STABILITY BEGIN -->
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>THERMAL STABILITY</u></strong> (UATM 013)</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">LENGTH</td>
        ...
        <!-- THERMAL STABILITY END -->
        <tr>
            <td align="center" style="font-size: 12px;" colspan="3">&nbsp;</td>
        </tr>
        <!-- PILLING LOCUS BEGIN -->
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>PILLING RESISTANCE : CIRCULAR LOCUS</u></strong> (GB/T 4802.1 PARAMETER E)</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">FACE</td>
            ...
            <td align="right" style="font-size: 11px;" width="33%">GRADE MIN <?php if($rstd['pill_locus1']!=''){echo $rstd['pill_locus1'];}else{}?></td>
        </tr>
        <!-- PILLING LOCUS END -->
    </table>
    <table width="100%" border="0">

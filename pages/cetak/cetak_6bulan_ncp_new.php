...
<thead>
    ...
    <tr>
        <td><table width="100%" border="1" class="table-list1">
            ...
            <tbody>
                <?php
                $qryDept=mysqli_query($con,"SELECT DISTINCT dept FROM tbl_ncp_qcf_new 
                ...
                ?>
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAllKnt=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='KNT' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllKnt=mysqli_fetch_array($qryAllKnt);
                            $qryAllKnt1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='KNT' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllKnt1=mysqli_fetch_array($qryAllKnt1);
                            $qryKnt=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='KNT' AND (masalah_dominan!=NULL OR masalah_dominan!='')
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAllDye=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='DYE' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllDye=mysqli_fetch_array($qryAllDye);
                            $qryAllDye1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='DYE' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllDye1=mysqli_fetch_array($qryAllDye1);
                            $qryDye=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='DYE' AND (masalah_dominan!=NULL OR masalah_dominan!='')
                            GROUP BY masalah_dominan
                            ORDER BY berat DESC LIMIT 5");
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAllLab=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='LAB' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllLab=mysqli_fetch_array($qryAllLab);
                            $qryAllLab1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='LAB' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllLab1=mysqli_fetch_array($qryAllLab1);
                            $qryLab=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='LAB' AND (masalah_dominan!=NULL OR masalah_dominan!='')
                            GROUP BY masalah_dominan
                            ORDER BY berat DESC LIMIT 5");
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAllFin=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='FIN' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllFin=mysqli_fetch_array($qryAllFin);
                            $qryAllFin1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='FIN' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllFin1=mysqli_fetch_array($qryAllFin1);
                            $qryFin=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='FIN' AND (masalah_dominan!=NULL OR masalah_dominan!='')
                            GROUP BY masalah_dominan
                            ORDER BY berat DESC LIMIT 5");
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAllMkt=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='MKT' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllMkt=mysqli_fetch_array($qryAllMkt);
                            $qryAllMkt1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='MKT' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllMkt1=mysqli_fetch_array($qryAllMkt1);
                            $qryMkt=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='MKT' AND (masalah_dominan!=NULL OR masalah_dominan!='')
                            GROUP BY masalah_dominan
                            ORDER BY berat DESC LIMIT 5");
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAllKnk=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='KNK' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllKnk=mysqli_fetch_array($qryAllKnk);
                            $qryAllKnk1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='KNK' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllKnk1=mysqli_fetch_array($qryAllKnk1);
                            $qryKnk=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='KNK' AND (masalah_dominan!=NULL OR masalah_dominan!='')
                            GROUP BY masalah_dominan
                            ORDER BY berat DESC LIMIT 5");
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAllRmp=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='RMP' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllRmp=mysqli_fetch_array($qryAllRmp);
                            $qryAllRmp1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='RMP' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllRmp1=mysqli_fetch_array($qryAllRmp1);
                            $qryRmp=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='RMP' AND (masalah_dominan!=NULL OR masalah_dominan!='')
                            GROUP BY masalah_dominan
                            ORDER BY berat DESC LIMIT 5");
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAllPpc=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='PPC' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllPpc=mysqli_fetch_array($qryAllPpc);
                            $qryAllPpc1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='PPC' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllPpc1=mysqli_fetch_array($qryAllPpc1);
                            $qryPpc=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='PPC' AND (masalah_dominan!=NULL OR masalah_dominan!='')
                            GROUP BY masalah_dominan
                            ORDER BY berat DESC LIMIT 5");
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAllBrs=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='BRS' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllBrs=mysqli_fetch_array($qryAllBrs);
                            $qryAllBrs1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='BRS' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllBrs1=mysqli_fetch_array($qryAllBrs1);
                            $qryBrs=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='BRS' AND (masalah_dominan!=NULL OR masalah_dominan!='')
                            GROUP BY masalah_dominan
                            ORDER BY berat DESC LIMIT 5");
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAllGkg=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='GKG' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllGkg=mysqli_fetch_array($qryAllGkg);
                            $qryAllGkg1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='GKG' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllGkg1=mysqli_fetch_array($qryAllGkg1);
                            $qryGkg=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='GKG' AND (masalah_dominan!=NULL OR masalah_dominan!='')
                            GROUP BY masalah_dominan
                            ORDER BY berat DESC LIMIT 5");
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAllGkj=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='GKJ' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllGkj=mysqli_fetch_array($qryAllGkj);
                            $qryAllGkj1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='GKJ' AND (masalah_dominan!=NULL OR masalah_dominan!='')");
                            $rAllGkj1=mysqli_fetch_array($qryAllGkj1);
                            $qryGkj=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='GKJ' AND (masalah_dominan!=NULL OR masalah_dominan!='')
                            GROUP BY masalah_dominan
                            ORDER BY berat DESC LIMIT 5");

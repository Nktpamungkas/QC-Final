...
<title>Cetak Disposisi Produksi</title>
<script>
...
<table width="100%">
  ...
  <tr>
    <td align="center"><strong><font size="+1">LAPORAN KELUHAN PELANGGAN EKSTERNAL &quot;DISPOSISI PRODUKSI&quot;</font><br />
  ...
  //$qry1=mysqli_query($con,"SELECT * FROM tbl_aftersales $Where $shft $subdpt $disposisipro $lgn ORDER BY pejabat ASC");
  if($Awal!="" or $GShift!="" or $Subdept!="" or $Langganan!=""){
    $qry1=mysqli_query($con,"SELECT * FROM tbl_aftersales WHERE sts_disposisipro='1' $Where $disposisipro $shft $subdpt $lgn ORDER BY pejabat,personil ASC");
    }else{
    $qry1=mysqli_query($con,"SELECT * FROM tbl_aftersales WHERE sts_disposisipro='1' $Where $disposisipro $shft $subdpt $lgn ORDER BY pejabat,personil ASC");
    }
  $tkirim=0;
      ...
      <td><table width="100%" border="0" class="table-list1">
        <tr>
          <td align="left" style="border-top:0px #000000 solid; 
                                            ...
                                            border-right:0px #000000 solid;" width="45%"><strong>DETAIL DISPOSISI PRODUKSI</strong></td>
        </tr>
      </table></td>
    </tr>
    <tr>
        ...
        <tr>
          <td style="border-top:0px #000000 solid; 
            ...
            <tr>
              <?php
              if($_GET['langganan']!=""){ $lgn =" AND langganan LIKE '%$_GET[langganan]%' "; }else{$lgn = " ";}
              $qry2=mysqli_query($con,"SELECT pejabat FROM tbl_aftersales WHERE

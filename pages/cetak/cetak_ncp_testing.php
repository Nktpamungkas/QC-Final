...
if($_GET['id']!=""){
$qry=mysqli_query($con,"SELECT * FROM tbl_ncp_qcf_testing WHERE id='$_GET[id]'");
}else{
$qry=mysqli_query($con,"SELECT * FROM tbl_ncp_qcf_testing WHERE no_ncp='$_GET[no_ncp]' and dept='$_GET[dept]' and nokk='$_GET[nokk]' ORDER BY revisi DESC ");

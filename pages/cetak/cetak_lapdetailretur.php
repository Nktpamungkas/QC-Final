...
<table width="100%">
  ...
  <tr>
	...
	$Awal=$_GET['awal'];
	$Akhir=$_GET['akhir'];		
  $qry1=mysqli_query($con,"SELECT * FROM tbl_detail_retur WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' ORDER BY tgltrm_sjretur ASC");
  //$qrygk=mysqli_query("");
  $troll=0;
  $tqty=0;
  $tqty_tu=0;

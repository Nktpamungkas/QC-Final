        ...
        <td><table width="100%" border="1" class="table-list1">
            ...
            <tbody>
                ...
                <tr align="center">
                    ...
                    while($rBrt=mysqli_fetch_array($qryBrt)){
                    ?>
                    <td align="right" valign="middle"><font size="-2"><?php if($rBrt['berat']=='' OR $rBrt['berat']==NULL){echo "0.00%";}else{if($ProDye>0){echo number_format(($rBrt['berat']/$ProDye)*100,2)."%";}}?></font></td>
                    <?php } 
                    } ?>
                    <td align="right">&nbsp;</td>
                </tr>
                ...
                <?php 
                    $qry=mysqli_query($con,"SELECT DISTINCT masalah_dominan AS masalah_dominan FROM tbl_ncp_qcf_new
                    WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1' ");
                ...
                <tr align="center">
                    ...
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalP1' AND '$AkhirP1'");
                    while($rDept=mysqli_fetch_array($qryDept)){
                        $qrybs=mysqli_query($con,"SELECT SUM(berat) AS berat FROM tbl_ncp_qcf_new 
                        WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalP1' AND '$AkhirP1'
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td align="right" style="border-top:0px #000000 solid; 
                                            border-bottom:0px #000000 solid;
                                            border-left:0px #000000 solid; 
                                            border-right:0px #000000 solid;" width="5%"><?php if($ProDye>0){echo number_format(($rAll1['berat']/$ProDye)*100,2)."%";}?></td>
                    <td align="left" style="border-top:0px #000000 solid; 
                                            border-bottom:0px #000000 solid;
                                            border-left:0px #000000 solid; 
                ...
                <tr>
                    ...
                    <td align="right" style="border-top:0px #000000 solid; 
                                            border-bottom:0px #000000 solid;
                                            border-left:0px #000000 solid; 
                                            border-right:0px #000000 solid;" width="10%"><?php if($ProDye>0){echo number_format($ProDye,2);}?></td>
                    <td align="left" style="border-top:0px #000000 solid; 
                                            border-bottom:0px #000000 solid;
                                            border-left:0px #000000 solid; 
                                            border-right:0px #000000 solid;" width="5%">&nbsp;</td>

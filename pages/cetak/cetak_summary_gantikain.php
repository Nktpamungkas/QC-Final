    ...
    <tr>
        <td><table width="100%" border="1" class="table-list1">
            ...
            <tr>
              ...
              $tpjg_gk=0;
              $tpjg_email=0;
              $qry1=mysqli_query($con,"SELECT buyer, SUM(kg1) AS qty_gk, SUM(pjg1) AS pjg_gk, SUM(qty_email) AS qty_email, SUM(pjg_email) AS pjg_email FROM tbl_ganti_kain WHERE

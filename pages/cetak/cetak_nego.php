  ...
  $tclaim=0;
		 ...
		 ?>
          <tr valign="top">
            ...
            <td valign="top"><font size="-2"><?php if($row1['checknego']=="Ceklis"){echo "&#10004";}else{echo "X";}?></font></td>
          </tr>
		<?php	$no++; 
        ...
        <tr>
          <td style="border-top:0px #000000 solid; 
            ...
            <tr>
                ...
                <td align="left" colspan="17"><strong><?php echo number_format($TotalKirim,2)." Kg"; ?></strong></td>
            </tr>
            <tr>
                <td align="left"><strong>Total Lot Negosiasi</strong></td>
                <td align="left" colspan="17"><strong><?php echo $rTotal['total_lot_nego']; ?></strong></td>
            </tr>
          </table></td>
        </tr>
      </table></td>

...
<table width="100%">
            ...
            <td><table width="100%" border="0" class="table-list1">  
                <tr>
                    <td align="center" colspan="8" valign="middle" style="border-top:0px #000000 solid; 
                                ...
                                border-right:0px #000000 solid;"><strong><font size="-2" >FABRIC TEST REPORT</font> <br> FW-12-QCF-04/04</strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="right" style="border-top:0px #000000 solid; 
                                border-bottom:0px #000000 solid;
                                border-left:0px #000000 solid; 
                                border-right:0px #000000 solid;">Version : Sep. 2022</td>
                </tr>
                </table>
    ...
    <tr>
        ...
        <tr>
            ...
            <td align="left" style="font-size: 8px;">See Test Method<br>X1 Wash<br>Spirality<br>Appearance: No Obvious Change<br>colour change of &ge; 4-5</td>
            ...
            <?php if($rcek1['stat_fwss']=="RANDOM"){echo $rcekR['rspirality1'];}else if($rcek1['stat_fwss']=="DISPOSISI"){echo $rcekD['dspirality1'];}else{echo $rcek1['spirality1'];}?><br>
            ...
            <td align="left" style="font-size: 8px;">(%) Length<br>(%) Width<br>(%) Spirality<br>pass/fail<br>(grade)</td>
            <td align="center" rowspan="4" style="font-size: 8px;"><?php if($rcek1['stat_fwss']=="A" OR $rcek1['stat_fwss']=="PASS" OR $rcek1['stat_fwss']=="FAIL" OR $rcek1['stat_fwss']=="RANDOM" OR $rcek1['stat_fwss']=="DISPOSISI"){echo "A";}?></td>
            <td align="center" rowspan="4" style="font-size: 8px;"><?php if($rcek1['stat_fwss']=="R"){echo "R";}?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 8px;">See Test Method<br>(<?php if($rcek1['ss_washes3']=='3'){echo "&#10003;"; }?>)X3 Washes<br>Spirality<br>Appearance: No Obvious Change<br>colour change of &ge; 4-5</td>
            <td align="center" style="font-size: 8px;">
            ...
            <?php if($rcek1['stat_fwss']=="RANDOM"){echo $rcekR['rspirality2'];}else if($rcek1['stat_fwss']=="DISPOSISI"){echo $rcekD['dspirality2'];}else{echo $rcek1['spirality2'];}?><br>
        ...
        <tr>
            <td align="left" style="font-size: 8px;">See Test Method<br>(<?php if($rcek1['ss_washes10']=='10'){echo "&#10003;"; }?>)X10 Washes<br>Spirality<br>Appearance: No Obvious Change<br>colour change of &ge; 4-5</td>
            <td align="center" style="font-size: 8px;">
            ...
            <?php if($rcek1['stat_fwss']=="RANDOM"){echo $rcekR['rspirality3'];}else if($rcek1['stat_fwss']=="DISPOSISI"){echo $rcekD['dspirality3'];}else{echo $rcek1['spirality3'];}?><br>
        ...
        <tr>
            <td align="left" style="font-size: 8px;">See Test Method<br>(<?php if($rcek1['ss_washes15']=='15'){echo "&#10003;"; }?>)X15 Washes<br>Spirality<br>Appearance: No Obvious Change<br>colour change of &ge; 4-5</td>
            <td align="center" style="font-size: 8px;">
            ...
            <?php if($rcek1['stat_fwss']=="RANDOM"){echo $rcekR['rspirality4'];}else if($rcek1['stat_fwss']=="DISPOSISI"){echo $rcekD['dspirality4'];}else{echo $rcek1['spirality4'];}?><br>
        ...
        <tr>
            ...
            <td align="left" style="font-size: 8px;"><strong>Fabric:</strong>(length & width direction at 60N)<br>High EL (>8%)<br>Warp: >100% X 80% / >80% X 100%<br>Weft: > 70% X 90% / >90% X 70%<br>Low EL (< 8%)<br>Warp & Weft: >80% X 30% / >30% X 80%<br>Rib as Trims: (width direction at 22N): &ge;80%<br><strong>Rib :</strong> (width direction at 22N):&ge;100%</td>
            <td align="center" style="font-size: 8px;">
    ...
    <tr>
        ...
        <tr>
            <td align="right" style="font-size: 8px;" colspan="9"><strong>Report issued date: <?php if($rd2['no_test']=='202203081015'){echo "2022-03-08";}else if($rd2['no_test']=='202203101250'){echo "2022-03-10";}else{echo $now;}?></strong></td>
        </tr>
        </table>
    </table></td>
    </tr>

                    ...
                    <tbody>
                        ...
                        ?>
                            <tr valign="top">
                                ...
                                <td>
                                    <?php
                                        $nomesin_hasilcelup = mysqli_query($condye, "SELECT
                                                                                        ...
                                                                                        WHERE
                                                                                            a.nokk = '$row1[prod_order]' OR a.nodemand = '$dt_ori_pd_code[VALUESTRING]'");
                                ...
                                <td>
                                    <?php
                                        $cw_dyeing = mysqli_query($con, "SELECT status_warna FROM `tbl_cocok_warna_dye`
                                                                                    WHERE nokk = '$row1[prod_order]' OR nodemand = '$dt_ori_pd_code[VALUESTRING]'");
                                    ...
                                    <?php
                                        $cw_fin_oven = mysqli_query($con, "SELECT `status` 
                                                                                    FROM
                                                                                        `tbl_lap_inspeksi` 
                                                                                    WHERE
                                                                                        ( nokk = '$row1[prod_order]' or nodemand = '$dt_ori_pd_code[VALUESTRING]') 
                                                                                        AND proses = 'Oven'
                                                                                    AND dept = 'QCF'");

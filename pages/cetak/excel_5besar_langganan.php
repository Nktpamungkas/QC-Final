...
<table width="100%" border="1">
    ...
    $qrylgn=mysqli_query($con,"SELECT COUNT(*) AS jml, ROUND(COUNT(langganan)/(SELECT COUNT(*) FROM tbl_aftersales WHERE tgl_buat BETWEEN '$Awal' AND '$Akhir')*100,1) AS persen,
    langganan
    FROM
    `tbl_aftersales`

...
<body>
    <table width="100%">
        ...
        <tr>
            <td><table width="100%" border="0" class="table-list1"> 
                ...
                <tr>
                    ...
                    border-left:0px #000000 solid; 
                    border-right:0px #000000 solid; font-family: Arial,sans-serif;" width="100%"><strong>Technical Report : </strong> <br> <?php echo 'INDO-'.$rd2['season'].$uaproduct.$rd2['no_hanger'].'-'.$rd2['warna'].'-'.$rd2['no_rptua'];;?></td>
                </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right" style="font-size: 12px;">Page 1 of 7</td> 
        </tr>
        <tr>
    ...
    <table width="100%">
        ...
        <tr>
            <td align="left" style="font-size: 12px;" width="50%">TO : <?php echo $langganan;?></td> 
            <td align="right" style="font-size: 12px;" width="25%">LAB NO</td> 
            <td align="right" style="font-size: 12px;" width="3%">:</td> 
            <td align="left" style="font-size: 12px;" width="25%">M0011-2022</td> 
        </tr>
        <tr>
            <?php 
            ...
            ?>
            <td align="left" style="font-size: 12px;" width="50%">ATTN : <?php if($attn['person']!=''){echo $attn['phone']." (".$attn['person'].")";}else{echo $attn['phone'];}?></td>
        ...
        <tr>
            <td align="left" style="font-size: 12px;" width="50%">&nbsp;</td>
            <td align="right" style="font-size: 12px;" width="25%">PAGE 2 OF 7</td> 
            <td align="right" style="font-size: 12px;" width="3%">&nbsp;</td> 
    ...
    <table width="100%" border="1" class="table-list1">
        ...
        <tbody>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_fla']==""){echo "N/A";}else if($rcek1['stat_fla']!=""){echo $rcek1['fla_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_fwss3']==""){echo "N/A";}else if($rcek1['stat_fwss3']!=""){echo $rcek1['fwi_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_fwss2']==""){echo "N/A";}else if($rcek1['stat_fwss2']!=""){echo $rcek1['fwe_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_fwss']==""){echo "N/A";}else if($rcek1['stat_fwss']!=""){echo $rcek1['ss_cmt'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_bsk']==""){echo "N/A";}else if($rcek1['stat_bsk']!=""){echo $rcek1['bas_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_ap']==""){echo "N/A";}else if($rcek1['stat_ap']!=""){echo $rcek1['apper_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_sr']==""){echo "N/A";}else if($rcek1['stat_sr']!=""){echo $rcek1['stretch_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_gr']==""){echo "N/A";}else if($rcek1['stat_gr']!=""){echo $rcek1['growth_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_prt']==""){echo "N/A";}else if($rcek1['stat_prt']!=""){echo $rcek1['pillr_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_sm']==""){echo "N/A";}else if($rcek1['stat_sm']!=""){echo $rcek1['snam_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_abs']==""){echo "N/A";}else if($rcek1['stat_abs']!=""){echo $rcek1['absor_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_fc']==""){echo "N/A";}else if($rcek1['stat_fc']!=""){echo $rcek1['fc_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_bs2']==""){echo "N/A";}else if($rcek1['stat_bs2']!=""){echo $rcek1['burs_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_ph']==""){echo "N/A";}else if($rcek1['stat_ph']!=""){echo $rcek1['ph_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_wf']==""){echo "N/A";}else if($rcek1['stat_wf']!=""){echo $rcek1['wash_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_wtr']==""){echo "N/A";}else if($rcek1['stat_wtr']!=""){echo $rcek1['water_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_pac']==""){echo "N/A";}else if($rcek1['stat_pac']!="" AND $rcek1['stat_pal']!=""){echo $rcek1['acid_note']." ".$rcek1['alkaline_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_cr']==""){echo "N/A";}else if($rcek1['stat_cr']!=""){echo $rcek1['crock_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_dye']==""){echo "N/A";}else if($rcek1['stat_dye']!=""){echo $rcek1['dye_tf_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_lg']==""){echo "N/A";}else if($rcek1['stat_lg']!=""){echo $rcek1['light_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_py']==""){echo "N/A";}else if($rcek1['stat_py']!=""){echo $rcek1['phenolic_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_chl']==""){echo "N/A";}else if($rcek1['stat_chl']!=""){echo $rcek1['chlorin_note'];}else{echo "&nbsp;";}?></td>
            </tr>
            <tr>
                ...
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_hs']==""){echo "N/A";}else if($rcek1['stat_hs']!=""){echo $rcek1['h_shrinkage_note'];}else{echo "&nbsp;";}?></td>
            </tr>
        </tbody>
    </table>
    <table width="100%" border="1" class="table-list1">
    ...
    <table width="100%">
        ...
        <tr>
            <td align="center" style="font-size: 12px;">ASST. SUPERVISOR QCF</td>
            <td align="center" style="font-size: 12px;">&nbsp;</td>
            <td align="center" style="font-size: 12px;">ASST. MANAGER QCF</td>
        </tr>
    </table>
    <table width="100%" border="0">
        <?php 
        ...
        ?>
        <tr>
            <td align="right" style="font-size: 12px;">PAGE 3 OF 7</td> 
        </tr>
        <tr>
    ...
    <table width="100%">
        ...
        <tr>
            <td align="left" style="font-size: 11px;" colspan="3">MODIFIED, TIDE, 3 WASH, NORMAL CYCLE AT 40 DEGREE CELCIUS. TUMBLE DRY LOW, 4-LBS LOAD,</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" colspan="3">MEASURE AT 10 INCHES. UNRESTORED</td>
        </tr>
        <tr>
            <td align="center" style="font-size: 12px;" colspan="3">&nbsp;</td>
        </tr>
        ...
        <tr>
            <td align="left" style="font-size: 11px;" colspan="3">METHOD 1, OPTION 1, 3 MACHINE WAS, NORMAL CYCLE AT 40 DEGREE CELCIUS, TUMBLE DRY LOW</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">KNIT-AFTER 3 WASHES(%)</td>
        ...
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3">SUBJECTIVE, MACHINE WASH COLD, NORMAL CYCLE, TUMBLE DRY LOW, AFTER 3 WASHES</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">ANY OBSERVED DEFECTS</td>
            <td align="center" style="font-size: 11px;" width="33%"><?php if($rcek1['stat_ap']=="DISPOSISI"){echo $rcekD['dapper_cc1'];}else if($rcek1['apper_cc1']!=''){echo $rcek1['apper_cc1'];}else{echo "N/A";}?></td>
        ...
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3">SUBJECTIVE, MACHINE WASH COLD, NORMAL CYCLE, TUMBLE DRY LOW, AFTER 10 WASHES</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">ANY OBSERVED DEFECTS</td>
            <td align="center" style="font-size: 11px;" width="33%"><?php if($rcek1['stat_ap']=="DISPOSISI"){echo $rcekD['dapper_st'];}else if($rcek1['apper_st']!=''){echo $rcek1['apper_st'];}else{echo "N/A";}?></td>
            <td align="right" style="font-size: 11px;" width="33%"><?php if($rstd['appearance2']!=''){echo $rstd['appearance2'];}else{}?></td>
        </tr>
        ...
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>TENSION AND ELONGATION OF ELASTIC FABRICS</u></strong> (ASTM D4964)</td>
        </tr>
        <tr>
            <td align="center" style="font-size: 12px;" colspan="3">&nbsp;</td>
        </tr>
        ...
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3">AT SPESIFIC LOAD 5 LBF</td>
        </tr>
        <tr>
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="right" style="font-size: 12px;">PAGE 5 OF 7</td> 
        </tr>
        <tr>
            <td align="center" style="font-size: 15px;">&nbsp;</td> 
        </tr>
    ...
    <table width="100%">
        ...
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">LENGTH:GROWTH</td>
        ...
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">WIDTH:GROWTH</td>
        ...
        <tr>
            ...
            <td align="right" style="font-size: 11px;" width="33%">MIN. <?php if($rstd['snag_mace1']!=''){echo $rstd['snag_mace1'];}else{}?></td>
        </tr>
        <tr>
            ...
            <td align="right" style="font-size: 11px;" width="33%">MIN. <?php if($rstd['snag_mace2']!=''){echo $rstd['snag_mace2'];}else{}?></td>
        </tr>
        ...
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">WALES / INCH</td>
        ...
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">COURSES / INCH</td>
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="right" style="font-size: 12px;">PAGE 6 OF 7</td> 
        </tr>
        <tr>
            <td align="center" style="font-size: 15px;">&nbsp;</td> 
        </tr>
    ...
    <table width="100%" border="0">
        ...
        ?>
        <tr>
            <td align="right" style="font-size: 12px;">PAGE 7 OF 7</td> 
        </tr>
        <tr>
            <td align="center" style="font-size: 15px;">&nbsp;</td> 
        </tr>

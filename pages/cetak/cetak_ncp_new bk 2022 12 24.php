...
<table width="100%" border="0" >
  <tbody>
    ...
    <tr>
      <td colspan="5" align="center"><font size="-1"><strong>No. NCP: <?php echo $noncpG;?></strong></font></td>
    </tr>
	</tbody>
	</table>
<table border="0" width="100%">
	...
	border-bottom:1px #000000 solid;
	border-left:1px #000000 solid; 
	border-right:1px #000000 solid;"><?php if($d['lot_salinan']){ echo $d['lot_salinan']; }else{ echo $d['lot']; } ?></td>
      <td valign="top" style="border-top:1px #000000 solid; 
	border-bottom:1px #000000 solid;
	border-left:1px #000000 solid; 
...
<table border="0" width="100%">
  <tbody>
	...
	border-bottom:1px #000000 solid;
	border-left:1px #000000 solid; 
	border-right:1px #000000 solid;">Ket. <?php if($d['ncp_hitung']=="ya"){echo "Hitung, ";}?> <?php if($d['ok_celupan']!=""){echo "Warna OK Celupan ".$d['ok_celupan']." dan ";}?> <?php echo $d['ket'];?></td>
    </tr>
  </tbody>
</table>
<table border="0" width="100%">

...
<table width="100%" border="1">
	...
	<?php 
	$no=1;
	$query=mysqli_query($con,"SELECT * FROM tbl_tq_nokk a 
    ...
    <tr>
      ...
      <td><?php echo $rR['rol'];?></td>
      <td><?php echo $rR['netto'];?></td>
      ...
      <td><?php echo $r['sns_note'];?></td> <!--19-->
      <td><?php echo $r['fibre_transfer'];?></td>
      <td><?php echo $r['fibre_grade'];?></td>
      <td><?php echo $r['fibre_note'];?></td><!--3-->
      <td><?php echo $r['odour'];?></td>
      <td><?php echo $r['odour_note'];?></td><!--2-->
      <td><?php echo $r['bow'];?></td>
      <td><?php echo $r['skew'];?></td>
      <td><?php echo $r['bas_note'];?></td><!--3-->
      ...
      <td><?php echo $r['pillm_note'];?></td><!--11-->
      <td><?php echo $r['pb_f1'];?></td>
      <td><?php echo $r['pb_b1'];?></td>
      <td><?php echo $r['pillb_note'];?></td><!--3-->
      ...
      <td><?php echo $r['pillr_note'];?></td><!--11-->
      <td><?php echo $r['pl_f1'];?></td>
      <td><?php echo $r['pl_b1'];?></td>
      <td><?php echo $r['pl_f2'];?></td>
      <td><?php echo $r['pl_b2'];?></td>
      <td><?php echo $r['pl_f3'];?></td>
      <td><?php echo $r['pl_b3'];?></td>
      <td><?php echo $r['pl_f4'];?></td>
      <td><?php echo $r['pl_b4'];?></td>
      <td><?php echo $r['pl_f5'];?></td>
      <td><?php echo $r['pl_b5'];?></td>
      <td><?php echo $r['pilll_note'];?></td><!--11-->
      <td><?php echo $r['abration'];?></td>
      <td><?php echo $r['abr_note'];?></td><!--2-->
      ...
      <td><?php echo $r['absor_note'];?></td><!--7-->
      <td><?php echo $r['dry1'];?></td>
      <td><?php echo $r['dry2'];?></td>
      <td><?php echo $r['dry3'];?></td>
      <td><?php echo $r['dryaf1'];?></td>
      <td><?php echo $r['dryaf2'];?></td>
      <td><?php echo $r['dryaf3'];?></td>
      <td><?php echo $r['dry_note'];?></td><!--7-->
      <td><?php echo $r['repp1'];?></td>
      <td><?php echo $r['repp2'];?></td>
      <td><?php echo $r['repp3'];?></td>
      <td><?php echo $r['repp4'];?></td>
      <td><?php echo $r['repp_note'];?></td><!--5-->
      <td><?php echo $r['load_stretch'];?></td>
      ...
      <td>&nbsp;</td>
      <td><?php echo $r['stretch_note']." ".$r['recover_note'];?></td><!--32-->
      <td><?php echo $r['growth_l1'];?></td>
      <td><?php echo $r['growth_l2'];?></td>
      <td><?php echo $r['growth_w1'];?></td>
      <td><?php echo $r['growth_w2'];?></td>
      <td><?php echo $r['rec_growth_l1'];?></td>
      <td><?php echo $r['rec_growth_l2'];?></td>
      <td><?php echo $r['rec_growth_w1'];?></td>
      <td><?php echo $r['rec_growth_w2'];?></td>
      <td><?php echo $r['growth_note'];?></td><!--9-->
      <td><?php echo $r['apper_ch1'];?></td>
      <td><?php echo $r['apper_st'];?></td>
      <td><?php echo $r['apper_pf1'];?></td>
      <td><?php echo $r['apper_pb1'];?></td>
      <td><?php echo $r['apper_acetate'];?></td>
      <td><?php echo $r['apper_cotton'];?></td>
      <td><?php echo $r['apper_nylon'];?></td>
      <td><?php echo $r['apper_poly'];?></td>
      <td><?php echo $r['apper_acrylic'];?></td>
      <td><?php echo $r['apper_wool'];?></td>
      <td><?php echo $r['apper_ch2'];?></td>
      <td><?php echo $r['apper_pf2'];?></td>
      <td><?php echo $r['apper_pb2'];?></td>
      <td><?php echo $r['apper_st2'];?></td>
      <td><?php echo $r['apper_ch3'];?></td>
      <td><?php echo $r['apper_pf3'];?></td>
      <td><?php echo $r['apper_pb3'];?></td>
      <td><?php echo $r['apper_st3'];?></td>
      <td><?php echo $r['apper_note'];?></td><!--19-->
      <td><?php echo $r['thick1'];?></td>
      <td><?php echo $r['thick2'];?></td>
      <td><?php echo $r['thick3'];?></td>
      <td><?php echo $r['thickav'];?></td>
      <td><?php echo $r['thick_note'];?></td><!--5-->
      <td><?php echo $r['fc_cott'];?></td>
      <td><?php echo $r['fc_poly'];?></td>
      <td><?php echo $r['fc_elastane'];?></td>
      <td>&nbsp;</td>
      <td><?php echo $r['fiber_note'];?></td><!--5-->
      <td><?php echo $r['flamability'];?></td>
      <td><?php echo $r['fla_note'];?></td><!--2-->
      <td><?php echo $r['fc_cpi'];?></td>
      <td><?php echo $r['fc_wpi'];?></td>
      <td><?php echo $r['fc_note'];?></td><!--3-->
      ...
      <td><?php echo $r['snap_note'];?></td><!--21-->
      <td><?php echo $r['wash_temp'];?></td>
      <td><?php echo $r['wash_colorchange'];?></td>
      <td><?php echo $r['wash_acetate'];?></td>
      <td><?php echo $r['wash_cotton'];?></td>
      <td><?php echo $r['wash_nylon'];?></td>
      <td><?php echo $r['wash_poly'];?></td>
      <td><?php echo $r['wash_acrylic'];?></td>
      <td><?php echo $r['wash_wool'];?></td>
      <td><?php echo $r['wash_staining'];?></td>
      <td><?php echo $r['wash_note'];?></td><!--10-->
      <td><?php echo $r['acid_colorchange'];?></td>
      <td><?php echo $r['acid_acetate'];?></td>
      <td><?php echo $r['acid_cotton'];?></td>
      <td><?php echo $r['acid_nylon'];?></td>
      <td><?php echo $r['acid_poly'];?></td>
      <td><?php echo $r['acid_acrylic'];?></td>
      <td><?php echo $r['acid_wool'];?></td>
      <td><?php echo $r['acid_staining'];?></td>
      <td><?php echo $r['acid_note'];?></td><!--9-->
      <td><?php echo $r['alkaline_colorchange'];?></td>
      <td><?php echo $r['alkaline_acetate'];?></td>
      <td><?php echo $r['alkaline_cotton'];?></td>
      <td><?php echo $r['alkaline_nylon'];?></td>
      <td><?php echo $r['alkaline_poly'];?></td>
      <td><?php echo $r['alkaline_acrylic'];?></td>
      <td><?php echo $r['alkaline_wool'];?></td>
      <td><?php echo $r['alkaline_staining'];?></td>
      <td><?php echo $r['alkaline_note'];?></td><!--9-->
      <td><?php echo $r['water_colorchange'];?></td>
      <td><?php echo $r['water_acetate'];?></td>
      <td><?php echo $r['water_cotton'];?></td>
      <td><?php echo $r['water_nylon'];?></td>
      <td><?php echo $r['water_poly'];?></td>
      <td><?php echo $r['water_acrylic'];?></td>
      <td><?php echo $r['water_wool'];?></td>
      <td><?php echo $r['water_staining'];?></td>
      <td><?php echo $r['water_note'];?></td><!--9-->
      <td><?php echo $r['dye_tf_acetate'];?></td>
      <td><?php echo $r['dye_tf_cotton'];?></td>
      <td><?php echo $r['dye_tf_nylon'];?></td>
      <td><?php echo $r['dye_tf_poly'];?></td>
      <td><?php echo $r['dye_tf_acrylic'];?></td>
      <td><?php echo $r['dye_tf_wool'];?></td>
      <td><?php echo $r['dye_tf_cstaining'];?></td>
      <td><?php echo $r['dye_tf_sstaining'];?></td>
      <td><?php echo $r['dye_tf_note'];?></td><!--9-->
      <td><?php echo $r['crock_len1'];?></td>
      <td><?php echo $r['crock_len2'];?></td>
      <td><?php echo $r['crock_wid1'];?></td>
      <td><?php echo $r['crock_wid2'];?></td>
      <td><?php echo $r['crock_note'];?></td><!--5-->
      <td><?php echo $r['phenolic_colorchange'];?></td>
      <td><?php echo $r['phenolic_note'];?></td><!--2-->
      <td><?php echo $r['ph'];?></td>
      <td><?php echo $r['ph_note'];?></td><!--2-->
      <td><?php echo $r['soil'];?></td>
      <td><?php echo $r['soil_note'];?></td><!--2-->
      <td><?php echo $r['humidity'];?></td>
      <td><?php echo $r['humidity_note'];?></td><!--2-->
      <td><?php echo $r['light_rating1'];?></td>
      <td><?php echo $r['light_rating2'];?></td>
      <td><?php echo $r['light_note'];?></td><!--3-->
      <td><?php echo $r['cm_printing_colorchange'];?></td>
      <td><?php echo $r['cm_printing_note'];?></td><!--2-->
      <td><?php echo $r['cm_dye_temp'];?></td>
      <td><?php echo $r['cm_dye_colorchange'];?></td>
      <td><?php echo $r['cm_dye_stainingface'];?></td>
      <td><?php echo $r['cm_dye_note'];?></td><!--4-->
      <td><?php echo $r['light_pers_colorchange'];?></td>
      <td><?php echo $r['light_pers_note'];?></td><!--2-->
      <td><?php echo $r['saliva_staining'];?></td>
      <td><?php echo $r['saliva_note'];?></td><!--2-->
      <td><?php echo $r['bleeding'];?></td>
      <td><?php echo $r['bleeding_note'];?></td><!--2-->
      <td><?php echo $r['chlorin'];?></td>
      <td><?php echo $r['nchlorin1'];?></td>
      <td><?php echo $r['nchlorin2'];?></td>
      <td><?php echo $r['chlorin_note'];?></td><!--4-->
  </tr>
    <?php $no++;} ?>
</table>
</body>
...
<table width="100%">
  <thead>
    ...
    <?php
        $qryCek=mysqli_query($con,"SELECT DISTINCT t_jawab FROM tbl_detail_retur 
        WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir'
        UNION
        SELECT DISTINCT t_jawab1 AS t_jawab FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qrydye=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                    ...
                    <?php
                    $qrydye1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='DYE' OR `t_jawab1`='DYE' OR `t_jawab2`='DYE')");
                    $tdye=0;
                    while($rowdye1=mysqli_fetch_array($qrydye1)){
                        $qrydye2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qryfin=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur 
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qryfin1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='FIN' OR `t_jawab1`='FIN' OR `t_jawab2`='FIN')");
                    $tfin=0;
                    while($rowfin1=mysqli_fetch_array($qryfin1)){
                        $qryfin2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qryknt=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qryknt1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='KNT' OR `t_jawab1`='KNT' OR `t_jawab2`='KNT')");
                    $tknt=0;
                    while($rowknt1=mysqli_fetch_array($qryknt1)){
                        $qryknt2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qryqcf=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qryqcf1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='QCF' OR `t_jawab1`='QCF' OR `t_jawab2`='QCF')");
                    $tqcf=0;
                    while($rowqcf1=mysqli_fetch_array($qryqcf1)){
                        $qryqcf2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qryppc=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur 
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qryppc1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='PPC' OR `t_jawab1`='PPC' OR `t_jawab2`='PPC')");
                    $tppc=0;
                    while($rowppc1=mysqli_fetch_array($qryppc1)){
                        $qryppc2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qrymkt=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur 
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qrymkt1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='MKT' OR `t_jawab1`='MKT' OR `t_jawab2`='MKT')");
                    $tmkt=0;
                    while($rowmkt1=mysqli_fetch_array($qrymkt1)){
                        $qrymkt2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qrylab=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qrylab1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='LAB' OR `t_jawab1`='LAB' OR `t_jawab2`='LAB')");
                    $tlab=0;
                    while($rowlab1=mysqli_fetch_array($qrylab1)){
                        $qrylab2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qryrmp=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur 
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qryrmp1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='RMP' OR `t_jawab1`='RMP' OR `t_jawab2`='RMP')");
                    $trmp=0;
                    while($rowrmp1=mysqli_fetch_array($qryrmp1)){
                        $qryrmp2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qryprt=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur 
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qryprt1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='PRT' OR `t_jawab1`='PRT' OR `t_jawab2`='PRT')");
                    $tprt=0;
                    while($rowprt1=mysqli_fetch_array($qryprt1)){
                        $qryprt2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qrypro=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qrypro1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='PRO' OR `t_jawab1`='PRO' OR `t_jawab2`='PRO')");
                    $tpro=0;
                    while($rowpro1=mysqli_fetch_array($qrypro1)){
                        $qrypro2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qrygkj=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur 
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qrygkj1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='GKJ' OR `t_jawab1`='GKJ' OR `t_jawab2`='GKJ')");
                    $tgkj=0;
                    while($rowgkj1=mysqli_fetch_array($qrygkj1)){
                        $qrygkj2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qrycst=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur 
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qrycst1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='CST' OR `t_jawab1`='CST' OR `t_jawab2`='CST')");
                    $tcst=0;
                    while($rowcst1=mysqli_fetch_array($qrycst1)){
                        $qrycst2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qrygkg=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur 
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qrygkg1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='GKG' OR `t_jawab1`='GKG' OR `t_jawab2`='GKG')");
                    $tgkg=0;
                    while($rowgkg1=mysqli_fetch_array($qrygkg1)){
                        $qrygkg2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qryknk=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qryknk1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='KNK' OR `t_jawab1`='KNK' OR `t_jawab2`='KNK')");
                    $tknk=0;
                    while($rowknk1=mysqli_fetch_array($qryknk1)){
                        $qryknk2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qrybrs=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qrybrs1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='BRS' OR `t_jawab1`='BRS' OR `t_jawab2`='BRS')");
                    $tbrs=0;
                    while($rowbrs1=mysqli_fetch_array($qrybrs1)){
                        $qrybrs2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    <tr>
        ...
        <td align="center"><table border="0" class="table-list1" width="65%">
            <?php
                ...
                $Awal=$_GET['awal'];
                $Akhir=$_GET['akhir'];		
                $qrytas=mysqli_query($con,"SELECT t_jawab,t_jawab1,t_jawab2 FROM tbl_detail_retur
            ...
            <tr>
                <td style="border-top:0px #000000 solid; 
                                    ...
                                    border-right:0px #000000 solid;"><table border="0" class="table-list1" width="100%">
                    <?php
                    $qrytas1=mysqli_query($con,"SELECT DISTINCT masalah_dominan FROM tbl_detail_retur 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND tgl_sjretur!='0000-00-00' AND (`t_jawab`='TAS' OR `t_jawab1`='TAS' OR `t_jawab2`='TAS')");
                    $ttas=0;
                    while($rowtas1=mysqli_fetch_array($qrytas1)){
                        $qrytas2=mysqli_query($con,"SELECT t_jawab, t_jawab1, t_jawab2, IF(t_jawab2!='',kg/3,IF(t_jawab1!='',kg/2,kg)) AS kg FROM tbl_detail_retur 
    ...
    $totalreturn=$tdye+$tfin+$tknt+$tqcf+$tlab+$trmp+$tprt+$tpro+$tgkj+$tgkg+$tknk+$tbrs+$ttas;
    ?>
    ...
    <tr><td><br><br><br><br><br><br></td></tr>
    <?php 
        $qrybss=mysqli_query($con,"SELECT SUM(kg) as kgbss, ket FROM tbl_detail_retur 
    ...
    <tr>
        <td align="center"><table border="0" class="table-list1" width="65%">
            ...
            <?php 
                $qrybs=mysqli_query($con,"SELECT SUM(kg) as kgbs, ket FROM tbl_detail_retur

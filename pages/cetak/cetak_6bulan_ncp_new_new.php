            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        <td><table border="0" class="table-list1" width="100%">
                            <?php
                            $qryAll=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='$rDept[dept]'");
                            $rAll=mysqli_fetch_array($qryAll);
                            $qryAll1=mysqli_query($con,"SELECT SUM(berat) AS berat_all FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP2' AND '$AkhirP2'
                            AND `dept`='$rDept[dept]'");
                            $rAll1=mysqli_fetch_array($qryAll1);
                            $qry=mysqli_query($con,"SELECT DISTINCT masalah_dominan, SUM(berat) AS berat FROM tbl_ncp_qcf_new
                            WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                            AND `dept`='$rDept[dept]'
                        ...
                        <td><table border="0" class="table-list1" width="100%">
                            ...
                            <tr>
                                ...
                                <td align="right" width="10%"><?php if($ProDye>0){echo number_format(($r2['berat']/$ProDye)*100,2);} ?></td>
                            ...
                            <tr>
                                ...
                                <td align="left" width="5%">Kg</td>
                                <td align="right" width="10%"><?php if($ProDye>0) {echo number_format(($t1/$ProDye)*100,2);} ?></td>
                                <td align="left" width="5%">%</td>
                            </tr>
                            <tr>
                                <td align="right" width="10%"><?php echo number_format($rAll['berat_all'],2); ?></td>
                                <td align="left" width="5%">Kg</td>
                                <td align="right" width="10%"><?php if($ProDye>0){echo number_format(($rAll['berat_all']/$ProDye)*100,2);} ?></td>
                                <td align="left" width="5%">%</td>
                            </tr>
                            <?php if($rDept['dept']=="BRS"){?>
                            <tr>
                                ...
                                <td align="left" width="5%">&nbsp;</td>
                                <td align="right" width="10%"><?php if($ProBrs>0){echo number_format(($rAll['berat_all']/$ProBrs)*100,2);} ?></td>
                                <td align="left" width="5%">%</td>
                            </tr>
                            <?php } ?>
                            <?php if($rDept['dept']=="PRT"){?>
                            <tr>
                                <td align="right" width="10%">&nbsp;</td>
                                <td align="left" width="5%">&nbsp;</td>
                                <td align="right" width="10%"><?php if($ProPrt>0){echo number_format(($rAll['berat_all']/$ProPrt)*100,2);} ?></td>
                                <td align="left" width="5%">%</td>
                            </tr>
                            <?php } ?>
                        </table></td>
                        <td><table border="0" class="table-list1" width="100%">
                            ...
                            <tr>
                                ...
                                <td align="left" width="5%">Kg</td>
                                <td align="right" width="10%"><?php if($ProDye1>0){echo number_format(($r4['berat']/$ProDye1)*100,2);} ?></td>
                                <td align="left" width="5%">%</td>
                            </tr>
                            <?php 
                            $t2=$t2+$r4['berat'];
                            ...
                            <tr>
                                ...
                                <td align="left" width="5%">Kg</td>
                                <td align="right" width="10%"><?php if($ProDye1>0){echo number_format(($t3/$ProDye1)*100,2);} ?></td>
                                <td align="left" width="5%">%</td>
                            </tr>
                            <tr>
                                <td align="right" width="10%"><?php echo number_format($rAll1['berat_all'],2); ?></td>
                                <td align="left" width="5%">Kg</td>
                                <td align="right" width="10%"><?php if($ProDy1e>0){echo number_format(($rAll1['berat_all']/$ProDye1)*100,2);} ?></td>
                                <td align="left" width="5%">%</td>
                            </tr>
                            <?php if($rDept['dept']=="BRS"){?>
                            <tr>
                                <td align="right" width="10%">&nbsp;</td>
                                <td align="left" width="5%">&nbsp;</td>
                                <td align="right" width="10%"><?php if($ProBrs1>0){echo number_format(($rAll1['berat_all']/$ProBrs1)*100,2);} ?></td>
                                <td align="left" width="5%">%</td>
                            </tr>
                            <?php } ?>
                            <?php if($rDept['dept']=="PRT"){?>
                            <tr>
                                <td align="right" width="10%">&nbsp;</td>
                                <td align="left" width="5%">&nbsp;</td>
                                <td align="right" width="10%"><?php if($ProPrt1>0){echo number_format(($rAll1['berat_all']/$ProPrt1)*100,2);} ?></td>
                                <td align="left" width="5%">%</td>
                            </tr>
                            <?php } ?>
                        </table></td>
                ...
                <tr>
                    ...
                    <td align="left" style="border-top:0px #000000 solid; 
                                    border-bottom:0px #000000 solid;
                                    border-left:0px #000000 solid; 
                                    border-right:0px #000000 solid;"><strong><?php echo $totalP1." Kg";?> &nbsp; <?php if($ProDye>0){echo number_format(($totalP1/$ProDye)*100,2)." %";}?></strong></td>
                    <td align="left" style="border-top:0px #000000 solid; 
                                    border-bottom:0px #000000 solid;
                                    border-left:0px #000000 solid; 
                                    border-right:0px #000000 solid;"><strong><?php echo $totalP2." Kg";?> &nbsp; <?php if($ProDye1>0){echo number_format(($totalP2/$ProDye1)*100,2)." %";}?></strong></td>
                </tr>
                <tr>
                    <td align="left" style="border-top:0px #000000 solid; 
                                    border-bottom:0px #000000 solid;
        ...
        <td><table border="0" class="table-list1" width="40%">
            ...
            <tbody>
                <?php
                    $no1=1;
                    $total=0; 
                    $qryDept1=mysqli_query($con,"SELECT DISTINCT dept FROM tbl_ncp_qcf_new 
                    WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalP1' AND '$AkhirP1'");
                    while($rDept1=mysqli_fetch_array($qryDept1)){
                        $qryAll2=mysqli_query($con,"SELECT SUM(berat) AS berat FROM tbl_ncp_qcf_new
                        WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d') BETWEEN '$AwalP1' AND '$AkhirP1'
                ...
                <tr>
                    ...
                    <td align="center"><?php if($ProDye>0){echo number_format(($rAll2['berat']/$ProDye)*100,2);}?></td>
                </tr>
                    <?php $no1++;
                ...
                <tr>
                    ...
                    <td align="center" rowspan="2"><?php if($ProDye>0){echo number_format(($total/$ProDye)*100,2);}?></td>
                </tr>
                <tr>
                    ...
                    <td align="right"><?php if($ProDye>0){echo number_format($ProDye,2);}?></td>
                </tr>
            </tbody>
        </table></td>
    </tr>

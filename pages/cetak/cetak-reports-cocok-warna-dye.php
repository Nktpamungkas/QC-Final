    ...
    <td><table width="100%" border="1" class="table-list1">
        <thead>
          <tr align="center">
            ...
            <td rowspan="2"><font size="-2"><strong>No Barcode</strong></font></td>
            ...
            <td rowspan="2"><font size="-2"><strong>Grouping</strong></font></td>
            <td rowspan="2"><font size="-2"><strong>Hue</strong></font></td>
      ...
      $lotOK=0;$lotTBA=0;$lotTBB=0;$lotTBC=0;$lot=0;     
        ...
        ?>
          ...
          <td align="center"><font size="-2"><?php echo $row['grouping'];?></font></td>
          <td align="center"><font size="-2"><?php echo $row['hue'];?></font></td>

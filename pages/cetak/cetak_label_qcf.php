...
<table width="100%" border="0"style="width: 7in;">
  <tbody>    
	...
	border-left:0px #000000 solid; border-right:0px #000000 solid;"><div style="font-size:9px;">LOT: <?php if($cekr>0){echo $r['lot'];}else{echo $r1['lot'];}?> <?php if($r['lot_erp']!=''){echo " , ".$r['lot_erp'];}else if($r1['lot_erp']!=''){echo " , ".$r1['lot_erp'];}?></div></td>

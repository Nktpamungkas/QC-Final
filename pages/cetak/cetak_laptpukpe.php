            ...
            <td align="center"><table class="table-list1" width="100%">
		        ...
		        <tbody> 
                    ...
                    <?php
                        ...
                        $Akhir=$_GET['akhir'];
                        $no=1;
                        $qry1=mysqli_query($con,"SELECT * FROM tbl_tpukpe WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND if(tgl_conform!='0000-00-00',DATEDIFF(serah_qai, tgl_conform)<7, if(tgl_packing>tgl_kpe,DATEDIFF(serah_qai, tgl_packing)<7,DATEDIFF(serah_qai, tgl_kpe)<7)) ORDER BY id ASC");
                    ...
                    <?php
                        ...
                        $Akhir=$_GET['akhir'];
                        $no1=1;
                        $qry2=mysqli_query($con,"SELECT * FROM tbl_tpukpe WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND if(tgl_conform!='0000-00-00',DATEDIFF(serah_qai, tgl_conform)>=7, if(tgl_packing>tgl_kpe,DATEDIFF(serah_qai, tgl_packing)>=7,DATEDIFF(serah_qai, tgl_kpe)>=7)) ORDER BY id ASC");
                    ...
                    <?php
                        ...
                        $Akhir=$_GET['akhir'];
                        $no2=1;
                        $qry3=mysqli_query($con,"SELECT * FROM tbl_tpukpe WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND serah_qai='0000-00-00' ORDER BY id ASC");

...
<body>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            ?>
            <!-- <?php if($attn['person']!=''){echo $attn['phone']." (".$attn['person'].")";}else{echo $attn['phone'];}?> -->
    ...
    <table width="100%" border="1" class="table-list1">
        ...
        <tr>
            ...
            <td align="left" style="font-size: 12px;" width="25%">WICKING</td>
        </tr>
        <tr>
    ...
    <table width="100%" border="1" class="table-list1">
        ...
        <tbody>
            ...
            <tr>
                <td align="left" style="font-size: 12px;">THERMAL STABILITY</td>
            ...
            <tr>
                <td align="left" style="font-size: 12px;">THICKNESS</td>
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_th']=="PASS" OR $rcek1['stat_th']=="DISPOSISI"){echo "X";}else{echo "&nbsp;";}?></td>
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_th']=="FAIL"){echo "X";}else{echo "&nbsp;";}?></td>
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_th']=="DATA"){echo "X";}else{echo "&nbsp;";}?></td>
                <td align="center" style="font-size: 12px;"><?php if($rcek1['stat_th']==""){echo "N/A";}else if($rcek1['stat_th']!=""){echo $rcekD['dthick_note'];}else{echo "&nbsp;";}?></td>
            </tr>
        </tbody>
    </table>
    <table width="100%" border="1" class="table-list1">
    ...
    <table width="100%">
        ...
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>CUTTABLE WIDTH: UA METHOD</u></strong> (UATM 002)</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            ?>
            <td align="center" style="font-size: 11px; <?php if($rcek1['stat_fwss2']=="DISPOSISI" AND $rcekD['df_weight'] < $batas_bawah){echo "color:red;";}else if($rcek1['stat_fwss2']=="DISPOSISI" AND $rcekD['df_weight'] > $batas_atas){echo "color:red;";}else if($rcek1['stat_fwss2']!="DISPOSISI" AND $rcek1['f_weight']!="" AND $rcek1['f_weight'] < $batas_bawah){echo "color:red;";}else if($rcek1['stat_fwss2']!="DISPOSISI" AND $rcek1['f_weight']!="" AND $rcek1['f_weight'] > $batas_atas){echo "color:red;";}?>" width="33%"><?php if($rcek1['stat_fwss2']=="DISPOSISI"){echo $rcekD['df_weight'];}else if($rcek1['f_weight']!=""){echo $rcek1['f_weight'];}else{echo "N/A";}?></td>
        ...
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>APPEARANCE AFTER CARE 3 WASHES</u></strong> (AATCC 135)</td>
        </tr>
        <tr>
            <td align="center" style="font-size: 12px;" colspan="3">&nbsp;</td>
        </tr>
    ...
    <table width="100%">
        ...
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>PILLING RESISTANCE:RANDOM TUMBLE PILLING</u></strong> (UATM 017)</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">FACE (30 MIN)</td>
        ...
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">FACE (60 MIN)</td>
        ...
        <!-- SNAGGING BEGIN -->
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3"><strong><u>SNAGGING RESISTANCE OF FABRICS:MACE</u></strong> (ASTM D3939)</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3">(100 CYCLE)</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">WARP/WALES</td>
            <td align="center" style="font-size: 11px;" width="33%"> <?php if($rcek1['stat_sm']=="DISPOSISI"){echo $rcekD['dsm_l1'];}else if($rcek1['sm_l1']!=""){echo $rcek1['sm_l1'];}else{echo "N/A";}?></td>
        ...
        <tr>
            ...
            <td align="center" style="font-size: 11px;" width="33%"> <?php if($rcek1['stat_sm']=="DISPOSISI"){echo $rcekD['dsm_w1'];}else if($rcek1['sm_w1']!=""){echo $rcek1['sm_w1'];}else{echo "N/A";}?></td>
            <td align="right" style="font-size: 11px;" width="33%">MIN. GRADE <?php if($rstd['snag_mace2']!=''){echo $rstd['snag_mace2'];}else{}?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3">(300 CYCLE)</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">WARP/WALES</td>
            <td align="center" style="font-size: 11px;" width="33%"> <?php if($rcek1['stat_sm']=="DISPOSISI"){echo $rcekD['dsm_l2'];}else if($rcek1['sm_l2']!=""){echo $rcek1['sm_l2'];}else{echo "N/A";}?></td>
            <td align="right" style="font-size: 11px;" width="33%">MIN. GRADE <?php if($rstd['snag_mace3']!=''){echo $rstd['snag_mace3'];}else{}?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">WEFT/COURSES</td>
            <td align="center" style="font-size: 11px;" width="33%"> <?php if($rcek1['stat_sm']=="DISPOSISI"){echo $rcekD['dsm_w2'];}else if($rcek1['sm_w2']!=""){echo $rcek1['sm_w2'];}else{echo "N/A";}?></td>
            <td align="right" style="font-size: 11px;" width="33%">MIN. GRADE <?php if($rstd['snag_mace4']!=''){echo $rstd['snag_mace4'];}else{}?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 12px;" colspan="3">(600 CYCLE)</td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">WARP/WALES</td>
            ...
            <td align="right" style="font-size: 11px;" width="33%">MIN. GRADE <?php if($rstd['snag_mace5']!=''){echo $rstd['snag_mace5'];}else{}?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">WEFT/COURSES</td>
            ...
            <td align="right" style="font-size: 11px;" width="33%">MIN. GRADE <?php if($rstd['snag_mace6']!=''){echo $rstd['snag_mace6'];}else{}?></td>
        </tr>
    ...
    <table width="100%">
        ...
        <tr>
            <td align="left" style="font-size: 11px;" width="33%">COLOR CHANGE (20 AFU)</td>
            <td align="center" style="font-size: 11px;" width="33%"><?php if($rcek1['stat_lp']=="DISPOSISI"){echo $rcekD['dlight_pers_colorchange'];}else if($rcek1['light_pers_colorchange']!=""){echo $rcek1['light_pers_colorchange'];}else{echo "N/A";}?></td>
        ...
        <!-- THICKNESS BEGIN -->
        <tr>
            <td align="left" style="font-size: 11px;" width="33%"><strong><u>THICKNESS</u></strong> (ASTM D1777)</td>
            <td align="center" style="font-size: 11px;" width="33%"><?php if($rcek1['stat_th']=="DISPOSISI"){echo $rcekD['dthick1'];}else if($rcek1['thick1']!=""){echo $rcek1['thick1'];}else{echo "N/A";}?></td>
            <td align="right" style="font-size: 11px;" width="33%">GRADE MIN <?php if($rstd['thickness1']!=''){echo $rstd['thickness1'];}else{}?></td>
        </tr>
        <!-- THICKNESSG END -->
    </table>
    <table width="100%" border="0">

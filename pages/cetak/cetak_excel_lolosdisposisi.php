...
<table width="100%" border='1'>
  ...
  <thead>
	...
	$no=1;
  if($Awal!=""){
    $qry1=mysqli_query($con,"SELECT * FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$_GET[awal]' AND '$_GET[akhir]'
    ...
    $tclaim=0;
        ...
        $qryQCF=mysqli_query($con,"SELECT a.nokk, a.masalah_dominan, b.tgl_fin, b.tgl_ins, b.tgl_masuk, b.ket from tbl_aftersales a left join tbl_qcf b on a.nokk=b.nokk WHERE a.nokk='$row1[nokk]'");
      ...
      <td align="left" style="border-top:0px #000000 solid; 
        ...
        <tr>
          <td style="border-top:0px #000000 solid; 
            ...
            //Shift A
            $qryjml1=mysqli_query($con,"SELECT COUNT(*) as jml_a FROM tbl_aftersales WHERE
            ...
            <tr>
              <?php
              if($_GET['langganan']!=""){ $lgn =" AND langganan LIKE '%$_GET[langganan]%' "; }else{$lgn = " ";}
              $qry1=mysqli_query($con,"SELECT shift, shift2, if(shift2!='',qty_claim/2,qty_claim) as qty_claim_a FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='A' OR shift2='A') $lgn"); 
              //DEFECT LOLOS QC
              $qrylqcdefa=mysqli_query($con,"SELECT count(*) as jml_def, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan != 'Beda Warna' and 
              ...
              //BEDA WARNA LOLOS QC
              $qrylqcbwa=mysqli_query($con,"SELECT count(*) as jml_bw, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan = 'Beda Warna' and 
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='A' OR shift2='A')");
            ...
            <tr>
            <?php
              $qry2=mysqli_query($con,"SELECT shift, shift2, if(shift2!='',qty_claim/2,qty_claim) as qty_claim_b FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='B' OR shift2='B')  $lgn"); 
              //DEFECT LOLOS QC
              $qrylqcdefb=mysqli_query($con,"SELECT count(*) as jml_def, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan != 'Beda Warna' and 
              ...
              //BEDA WARNA LOLOS QC
              $qrylqcbwb=mysqli_query($con,"SELECT count(*) as jml_bw, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan = 'Beda Warna' and 
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='B' OR shift2='B')");
            ...
            <tr>
            <?php
              $qry3=mysqli_query($con,"SELECT shift, shift2, if(shift2!='',qty_claim/2,qty_claim) as qty_claim_c FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='C' OR shift2='C') $lgn "); 
              //DEFECT LOLOS QC
              $qrylqcdefc=mysqli_query($con,"SELECT count(*) as jml_def, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan != 'Beda Warna' and 
              ...
              //BEDA WARNA LOLOS QC
              $qrylqcbwc=mysqli_query($con,"SELECT count(*) as jml_bw, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan = 'Beda Warna' and 
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='C' OR shift2='C')");
            ...
            <tr>
            <?php
              $qry4=mysqli_query($con,"SELECT shift, shift2, if(shift2!='',qty_claim/2,qty_claim) as qty_claim_non FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='Non-Shift' OR shift2='Non-Shift') $lgn "); 
               //DEFECT LOLOS QC
               $qrylqcdefn=mysqli_query($con,"SELECT count(*) as jml_def, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan != 'Beda Warna' and 
               ...
               //BEDA WARNA LOLOS QC
               $qrylqcbwn=mysqli_query($con,"SELECT count(*) as jml_bw, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan = 'Beda Warna' and 
               DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='Non-Shift' OR shift2='Non-Shift')");
            ...
            <tr>
              <?php
              $qry5=mysqli_query($con,"SELECT shift, shift2, if(shift2!='',qty_claim/2,qty_claim) as qty_claim_qc2 FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='QC2' OR shift2='QC2') $lgn"); 
              //DEFECT LOLOS QC
              $qrylqcdefqc2=mysqli_query($con,"SELECT count(*) as jml_def, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan != 'Beda Warna' and 
              ...
              //BEDA WARNA LOLOS QC
              $qrylqcbwqc2=mysqli_query($con,"SELECT count(*) as jml_bw, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan = 'Beda Warna' and 
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='QC2' OR shift2='QC2')");
              ...
              <tr>
              <?php
              $qry6=mysqli_query($con,"SELECT shift, shift2, if(shift2!='',qty_claim/2,qty_claim) as qty_claim_tq FROM tbl_aftersales WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='Test Quality' OR shift2='Test Quality') $lgn"); 
              //DEFECT LOLOS QC
              $qrylqcdeftq=mysqli_query($con,"SELECT count(*) as jml_def, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan != 'Beda Warna' and 
              ...
              //BEDA WARNA LOLOS QC
              $qrylqcbwtq=mysqli_query($con,"SELECT count(*) as jml_bw, SUM(qty_claim) as qty_kg from tbl_aftersales where sts_check ='Ceklis' and masalah_dominan = 'Beda Warna' and 
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='Test Quality' OR shift2='Test Quality')");
          ...
          <table width="100%" border="1" class="table-list1">
            ...
            <tr>
              ...
              <?php 
                ...
                (SELECT COUNT(DISTINCT(pejabat)) AS jml_dispro FROM tbl_aftersales WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND sts_disposisipro = '1' AND pejabat!='') AS A,
                (SELECT COUNT(DISTINCT(pejabat)) AS jml_disqc FROM tbl_aftersales WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND sts_disposisiqc = '1' AND pejabat!='') AS B");
            ...
            <?php
            $pjbpro=mysqli_query($con,"SELECT DISTINCT pejabat AS pejabat, SUM(qty_claim) AS qty_claim FROM tbl_aftersales WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
            AND sts_disposisipro = '1' AND pejabat!='' 
            GROUP BY pejabat 
            ORDER BY qty_claim DESC");
            while($rpjbpro=mysqli_fetch_array($pjbpro)){
            $dpro=mysqli_query($con,"SELECT a.pejabat, SUM(a.qty_claim) AS qty_claim, b.qty_retur, c.qty_gantikain, d.qty_pg, e.qty_lg FROM tbl_aftersales a
                    LEFT JOIN 
                    (SELECT
                    pejabat, SUM(qty_claim) AS qty_retur FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
                    AND pejabat='$rpjbpro[pejabat]' AND sts_disposisipro='1' AND solusi='RETUR') b
                    ON a.pejabat = b.pejabat
                    LEFT JOIN 
                    (SELECT
                    pejabat, SUM(qty_claim) AS qty_gantikain FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
                    AND pejabat='$rpjbpro[pejabat]' AND sts_disposisipro='1' AND solusi='CUTTING LOSS (GANTI KAIN)') c
                    ON a.pejabat = c.pejabat
                    LEFT JOIN 
                    (SELECT
                    pejabat, SUM(qty_claim) AS qty_pg FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
                    AND pejabat='$rpjbpro[pejabat]' AND sts_disposisipro='1' AND solusi='PERBAIKAN GARMENT') d
                    ON a.pejabat = d.pejabat
                    LEFT JOIN 
                    (SELECT
                    pejabat, SUM(qty_claim) AS qty_lg FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
            ...
            <?php 
            $pjbqc=mysqli_query($con,"SELECT DISTINCT pejabat AS pejabat, SUM(qty_claim) AS qty_claim FROM tbl_aftersales WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
            AND sts_disposisiqc = '1' AND pejabat!='' 
            GROUP BY pejabat 
            ORDER BY qty_claim DESC");
            while($rpjbqc=mysqli_fetch_array($pjbqc)){
            $dqc=mysqli_query($con,"SELECT a.pejabat, SUM(a.qty_claim) AS qty_claim, b.qty_retur, c.qty_gantikain, d.qty_pg, e.qty_lg FROM tbl_aftersales a
            LEFT JOIN 
            (SELECT
            pejabat, SUM(qty_claim) AS qty_retur FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
            ...
            <?php } ?>
            <?php
            $dlolos=mysqli_query($con,"SELECT a.sts, SUM(a.qty_claim) AS qty_claim, b.qty_retur, c.qty_gantikain, d.qty_pg, e.qty_lg FROM tbl_aftersales a
            LEFT JOIN 
            (SELECT
            sts, SUM(qty_claim) AS qty_retur FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
            AND sts='1' AND solusi='RETUR') b
            ON a.sts = b.sts
            LEFT JOIN 
            (SELECT
            sts, SUM(qty_claim) AS qty_gantikain FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
            AND sts='1' AND solusi='CUTTING LOSS (GANTI KAIN)') c
            ON a.sts = c.sts
            LEFT JOIN 
            (SELECT
            sts, SUM(qty_claim) AS qty_pg FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
            AND sts='1' AND solusi='PERBAIKAN GARMENT') d
            ON a.sts = d.sts
            LEFT JOIN 
            (SELECT
            sts, SUM(qty_claim) AS qty_lg FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
            ...
            while($rktgr=mysqli_fetch_array($ktgr)){
                $dkt=mysqli_query($con,"SELECT a.kategori, SUM(a.qty_claim) AS qty_claim, b.qty_retur, c.qty_gantikain, d.qty_pg, e.qty_lg FROM tbl_aftersales a
                LEFT JOIN 
                (SELECT
                kategori, SUM(qty_claim) AS qty_retur FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
                AND kategori='$rktgr[kategori]' AND solusi='RETUR') b
                ON a.kategori = b.kategori
                LEFT JOIN 
                (SELECT
                kategori, SUM(qty_claim) AS qty_gantikain FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
                AND kategori='$rktgr[kategori]' AND solusi='CUTTING LOSS (GANTI KAIN)') c
                ON a.kategori = c.kategori
                LEFT JOIN 
                (SELECT
                kategori, SUM(qty_claim) AS qty_pg FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 
                AND kategori='$rktgr[kategori]' AND solusi='PERBAIKAN GARMENT') d
                ON a.kategori = d.kategori
                LEFT JOIN 
                (SELECT
                kategori, SUM(qty_claim) AS qty_lg FROM tbl_aftersales WHERE DATE_FORMAT(tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' 

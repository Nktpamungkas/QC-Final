    ...
    <tr>
        <td><table width="100%" border="1" class="table-list1">
            <thead>
                <tr align="center">
                    <?php 
                    $qryCDept=mysqli_query($con,"SELECT COUNT(DISTINCT dept) AS jml FROM tbl_ncp_qcf_new 
            ...
            <tr>
                ...
                while($rDept=mysqli_fetch_array($qryDept)){
                  ...
                  $qryTotal=mysqli_query($con,"SELECT SUM(berat) AS berat FROM tbl_ncp_qcf_new 
		...
		<?php  
            $qryBln=mysqli_query($con,"SELECT CONCAT(MONTHNAME(tgl_buat),' ',YEAR(tgl_buat)) AS bulan FROM tbl_ncp_qcf_new 
            WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalP1' AND '$AkhirP1' 
		 ...
		 ?>
            <tr valign="top">
                ...
                WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalP1' AND '$AkhirP1'");
                while($rDept=mysqli_fetch_array($qryDept)){
                $qryBrt=mysqli_query($con,"SELECT SUM(berat) AS berat FROM tbl_ncp_qcf_new 
                WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalP1' AND '$AkhirP1'
                ...
                <td align="right" valign="middle"><font size="-2"><?php if($rRtr['qty_retur']=='' OR $rRtr['qty_retur']==NULL){echo "0.00";}else{echo number_format($rRtr['qty_retur'],2);}?></font></td>
                <td align="center" valign="middle"><font size="-2"><?php if($TotalKirim>0){echo number_format(($rRtr['qty_retur']/$TotalKirim)*100,2);}?></font></td>
                <td align="center" valign="middle"><font size="-2"><input name="nama1" type="text" placeholder="Ketik" size="10" style="font-size:10px;" /></font></td>
                <td align="center" valign="middle"><font size="-2"><?php if($rPack['qty_packing']=='' OR $rPack['qty_packing']==NULL){echo "0.00";}else{echo number_format($rPack['qty_packing'],2);}?></font></td>
                <td align="right" valign="middle"><font size="-2"><input name="nama1" type="text" placeholder="Ketik" size="10" style="font-size:10px;" /></font></td>
                <td align="center" valign="middle"><font size="-2"><input name="nama1" type="text" placeholder="Ketik" size="10" style="font-size:10px;" /></font></td>
        ...
        ?>
            ...
            <?php 
            $qryBln1=mysqli_query($con,"SELECT CONCAT(MONTHNAME(tgl_buat),' ',YEAR(tgl_buat)) AS bulan FROM tbl_ncp_qcf_new 
            WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalP1' AND '$AkhirP1' 
            GROUP BY YEAR(tgl_buat), MONTH(tgl_buat)");
            ...
            <tr>
                ...
                (SELECT IFNULL(
                  (SELECT SUM(berat) FROM tbl_ncp_qcf_new 
                WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalP1' AND '$AkhirP1' 
            ...
            <tr>
                ...
                WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalP1' AND '$AkhirP1'");
                while($rDept1=mysqli_fetch_array($qryDept1)){
                $qryBrt1=mysqli_query($con,"SELECT IFNULL((SELECT SUM(berat) FROM tbl_ncp_qcf_new 
                WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalP1' AND '$AkhirP1' 
                AND dept='$rDept1[dept]' AND CONCAT(MONTHNAME(tgl_buat),' ',YEAR(tgl_buat))='$bln2' AND `status`!='Cancel'
                GROUP BY YEAR(tgl_buat), MONTH(tgl_buat)),0) AS berat_setelah");
                while($rBrt1=mysqli_fetch_array($qryBrt1)){
                ?>
                <td align="right" valign="middle"><font size="-2"><?php if($rBrt1['berat_setelah']=='0.00'){echo "0.00%";}else{ if($ProDye>0){echo number_format(($rBrt1['berat_setelah']/$ProDye)*100,2)."%";}}?></font></td>
                <?php } 
                } ?>
                <td align="center" valign="middle"><font size="-2">&nbsp;</font></td>
                <td align="center" valign="middle"><font size="-2">&nbsp;</font></td>
    ...
    <tr>
      <td><table border="1" class="table-list1" width="100%">
            ...
            while($rBln1[]=mysqli_fetch_assoc($qryBln1));{
              ...
              $indexBln=$rJml['jml_bulan'];
              $bln2=$rBln1[$indexBln]['bulan'];
              $qryTNCP=mysqli_query($con,"SELECT SUM(berat) AS total_berat FROM tbl_ncp_qcf_new 
              WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$AwalP1' AND '$AkhirP1' 
        ...
        <tr>
          ...
          <td align="left" style="border-top:0px #000000 solid; 
                                border-bottom:0px #000000 solid;
                                border-left:0px #000000 solid; 
                                border-right:0px #000000 solid;" width="80%"><?php if($ProDye>0){echo number_format(($rTNCP['total_berat']/$ProDye)*100,2)."%";}?></td>
        </tr>
        <?php } ?>
        <tr>
          <td align="left" style="border-top:0px #000000 solid; 
          ...
          <td align="left" style="border-top:0px #000000 solid; 
                                border-bottom:0px #000000 solid;
                                border-left:0px #000000 solid; 
                                border-right:0px #000000 solid;" width="90%" colspan="2"><?php if($ProDye>0){echo number_format($ProDye,2);}?></td>
        </tr>
      </table></td>    
    </tr>
    <tr>

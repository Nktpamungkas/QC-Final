...
$qry1=mysqli_query($con,"SELECT * FROM tbl_detail_retur WHERE id_nsp='$_GET[id_nsp]' LIMIT 1");
$r1=mysqli_fetch_array($qry1);

$qrybon=mysqli_query($con,"SELECT * FROM tbl_detail_retur WHERE id='$_GET[id_cek]' LIMIT 1");
        ...
        <tbody>
            ...
            <tr>
                ...
                <table style="width:7in; height:3.2in;" border="0" class="table-list1">
                    ...
                    <?php
                    if($_GET['id_cek']!=""){
                    $qry1=mysqli_query($con,"SELECT * FROM tbl_detail_retur
                    WHERE id='$_GET[id_cek]'");
                    $cek=mysqli_num_rows($qry1); 
                    $row=mysqli_fetch_array($qry1);
                    }
                    if($_GET['id_cek1']!=""){
                    $qry2=mysqli_query($con,"SELECT * FROM tbl_detail_retur
                    WHERE id='$_GET[id_cek1]'");
                    $cek2=mysqli_num_rows($qry2); 
                    $row1=mysqli_fetch_array($qry2);
                    }
                    if($_GET['id_cek2']!=""){
                    $qry3=mysqli_query($con,"SELECT * FROM tbl_detail_retur
                    ...
                    <tr>
                        ...
                        <td align="left" style="font-size:8px;"><?php echo substr($row['jenis_kain'],0,30);?></td>
                        <td align="center" style="font-size:7px;"><?php echo $row['warna'];?></td>
                    ...
                    <tr>
                        ...
                        <table width="100%">
                            <tbody>
                                <?php
                                $qry4=mysqli_query($con,"SELECT * FROM tbl_detail_retur 
                                WHERE id='$_GET[id_cek]'");
                                $row4=mysqli_fetch_array($qry4);
                                $qry5=mysqli_query($con,"SELECT * FROM tbl_detail_retur 
                                WHERE id='$_GET[id_cek1]'");
                                $row5=mysqli_fetch_array($qry5);
                                $qry6=mysqli_query($con,"SELECT * FROM tbl_detail_retur 
                                WHERE id='$_GET[id_cek2]'");

...
$ReportUA     = isset($_POST['no_rptua']) ? $_POST['no_rptua'] : '';
$Revisi     = isset($_POST['revisi']) ? $_POST['revisi'] : '';
$Sts_rev     = isset($_POST['sts_rev']) ? $_POST['sts_rev'] : '';
$sqlCek=mysqli_query($con,"SELECT * FROM tbl_tq_nokk WHERE (nokk='$nokk' OR nokk='$nokk_post') ORDER BY id DESC LIMIT 1");
$cek=mysqli_num_rows($sqlCek);
$rcek=mysqli_fetch_array($sqlCek);
$positem=strpos($rcek['no_item'], "(");
$uaproduct=substr($rcek['no_item'],$positem,20);

$sqlStyle=sqlsrv_query($conn,"select top 1
      ...
      dbo.fn_StockMovementDetails_GetTotalRollPCC(0, x.PCBID) as RollCount
		from
			...
			order by
				x.SODID, x.PCBID");
            $rStyle=sqlsrv_fetch_array($sqlStyle);
            $cStyle=sqlsrv_num_rows($sqlStyle);
    function autono_report()
    {
	include"koneksi.php";
        date_default_timezone_set('Asia/Jakarta');
        $thn= date("Y");
		$today= date("ymd");
        $sqlnorptua = mysqli_query($con,"SELECT no_rptua FROM tbl_tq_nokk WHERE substr(no_rptua,4,6) like '%".$today."%' ORDER BY no_rptua DESC LIMIT 1") or die(mysqli_error());
        $dt=mysqli_num_rows($sqlnorptua);
        if ($dt>0) {
    		$rd=mysqli_fetch_array($sqlnorptua);
            $dt=$rd['no_rptua'];
            $strd=substr($dt, 10, 2);
            $Urutd = (int)$strd;
        } else {
        ...
        $Urutd = $Urutd + 1;
        $Nold="";
        $nilaid=5-strlen($Urutd);
        for ($i=1;$i<=$nilaid;$i++) {
            $Nold= $Nold."0";
        }
        $no2 ="SLFT".$today.$Nold.$Urutd;
	...
	<?php if($_GET['nokk']!=""){ ?>
		<div class="alert alert-warning alert-dismissible">
			<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
				...
				<p>Jika Ingin Update File Upload, Harap Pilih File Kembali.</p>
		</div>
	<?php }?>
<div class="box box-info">
   	<div class="box-header with-border">
    	<h3 class="box-title">Report Under Armour</h3>
  	...
  	<div class="box-body"> 
	 	<div class="col-md-6">
                  ...
                  <label for="no_po" class="col-sm-3 control-label">No KK</label>
                  	<div class="col-sm-4">
						<div class="input-group">	  
							...
							onchange="window.location='ReportUA-'+this.value" value="<?php if($_GET['nokk']!=""){echo $_GET['nokk'];}else{echo $nokk_post;}?>" placeholder="No KK" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>	  
		  			</div>
            </div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					onchange="window.location='ReportUANoTes-'+this.value" value="<?php if($cek>0){echo $rcek['no_test'];}else{echo $_GET['no_test'];} ?>" >
				</div>				   
			</div>
	        <div class="form-group">
            ...
            <div class="form-group">
                <label for="no_rptua" class="col-sm-3 control-label">Report No</label>
                <div class="col-sm-6">
					<input name="no_rptua" type="text" class="form-control" id="no_rptua" placeholder="Report No" readonly
                    value="<?php if($nokk!="" AND ($rcek['no_rptua']=="" OR $rcek['no_rptua']==NULL)){echo autono_report(); }else if($nokk!="" AND $rcek['no_rptua']!=""){echo 'INDO-'.$rcek['season'].$uaproduct.$rcek['no_hanger'].'-'.$rcek['warna'].'-'.$rcek['no_rptua'];}else{echo $ReportUA;} ?>">
                	<!-- <input name="no_rptua" type="text" class="form-control" id="no_rptua" placeholder="Report No" 
                    value="<?php if($rcek['no_rptua']!=""){echo 'INDO-'.$rcek['season'].$uaproduct.$rcek['no_hanger'].'-'.$rcek['warna'].'-'.$rcek['no_rptua'];}else{echo $ReportUA;} ?>"> -->
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
				...
				<div class="col-sm-8">
					...
					value="<?php if($rcek['style']!="" OR $rcek['style']!=NULL){echo $rcek['style'];}else if($cStyle>0){echo $rStyle['OtherDesc'];}else{echo $Style;} ?>" placeholder="Style">
				</div>				   
            </div> 
            <div class="form-group">
                <label for="jns_kain" class="col-sm-3 control-label">Jenis Kain</label>
                <div class="col-sm-8">
					<textarea name="jns_kain" class="form-control" id="jns_kain" placeholder="Jenis Kain"><?php if($cek>0){echo $rcek['jenis_kain'];}else{echo $Jns_Kain;}?></textarea>
				</div>
            </div>
            <div class="form-group">
	  	...
	  	<div class="col-md-6"> 		  
			...
			<div class="form-group">
				<label for="test_type" class="col-sm-3 control-label">Test Type</label>
				<div class="col-sm-5">
					<input name="test_type" type="text" class="form-control" id="test_type" 
					value="<?php if($rcek['test_type']!="" OR $rcek['test_type']!=NULL){echo $rcek['test_type'];}else{echo $Test_Type;} ?>" placeholder="Test Type" required>
				</div>				   
            </div>
            <div class="form-group">
				<label for="fabric_finish" class="col-sm-3 control-label">Fabric Finish</label>
				<div class="col-sm-5">
					<input name="fabric_finish" type="text" class="form-control" id="fabric_finish" 
					value="<?php if($rcek['fabric_finish']!="" OR $rcek['fabric_finish']!=NULL){echo $rcek['fabric_finish'];}else{echo $Fabric_Finish;} ?>" placeholder="Fabric Finish" required>
				</div>				   
            </div>
            <!-- <div class="form-group">
			...
			<!-- <div class="form-group">
                <label for="protocol" class="col-sm-3 control-label">Protocol(s) Used</label>
                <div class="col-sm-6">
                    <div class="input-group">  
			...
			<div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="input-group">  
                        <select name="enduse" id="enduse" class="form-control select2" required>
                            <option selected="selected" value="">Pilih</option>
                            <option value="Top" <?php if($rcek['enduse']=="Top" OR $Enduse=="Top"){echo "SELECTED";}?>>Top</option>
                            <option value="Bottoms" <?php if($rcek['enduse']=="Bottoms" OR $Enduse=="Bottoms"){echo "SELECTED";}?>>Bottoms</option>
							<option value="Intimate" <?php if($rcek['enduse']=="Intimate" OR $Enduse=="Intimate"){echo "SELECTED";}?>>Intimate</option>
							<option value="Outwear" <?php if($rcek['enduse']=="Outwear" OR $Enduse=="Outwear"){echo "SELECTED";}?>>Outwear</option>
							<option value="Outwear, Bottoms" <?php if($rcek['enduse']=="Outwear, Bottoms" OR $Enduse=="Outwear, Bottoms"){echo "SELECTED";}?>>Outwear, Bottoms</option>
							<option value="Outwear, Top" <?php if($rcek['enduse']=="Outwear, Top" OR $Enduse=="Outwear, Top"){echo "SELECTED";}?>>Outwear, Top</option>
							<option value="Intimate, Bottoms" <?php if($rcek['enduse']=="Intimate, Bottoms" OR $Enduse=="Intimate, Bottoms"){echo "SELECTED";}?>>Intimate, Bottoms</option>
							<option value="Intimate, Top" <?php if($rcek['enduse']=="Intimate, Top" OR $Enduse=="Intimate, Top"){echo "SELECTED";}?>>Intimate, Top</option>
                        </select>
                    </div>
                </div>				   
		    </div>
			<div class="form-group">
				<label for="prev_rpt" class="col-sm-3 control-label">Previous Report no(s)</label>
				<div class="col-sm-5">
					<input name="prev_rpt" type="text" class="form-control" id="prev_rpt" 
					value="<?php if($rcek['prev_report']!="" OR $rcek['prev_report']!=NULL){echo $rcek['prev_report'];}else{echo $Prev_Rpt;} ?>" placeholder="Previous Report no(s)" required>
				</div>				   
            </div>
            <!-- <div class="form-group">
				<label for="color_abbrev" class="col-sm-3 control-label">Color Abbreviation</label>
				<div class="col-sm-5">
					<input name="color_abbrev" type="text" class="form-control" id="color_abbrev" 
					value="<?php if($rcek['color_abbrev']!="" OR $rcek['color_abbrev']!=NULL){echo $rcek['color_abbrev'];}else{echo $Color_Abbrev;} ?>" placeholder="Color Abbreviation" required>
				</div>				   
            </div> -->
			<div class="form-group">
                <label for="cover" class="col-md-3 control-label">Upload Foto Cover</label>
                <div class="col-sm-5">	  
                    <input type="file" id="cover" name="cover"><span style="color:red;"><?php if($cek>0){echo $rcek['cover'];} ?></span>
                    <span class="help-block with-errors"></span>
                </div>	  
            </div>
			<div class="form-group">
                <label for="reject1" class="col-md-3 control-label">Upload Reject 1</label>
                <div class="col-sm-5">	  
			...
			<div class="form-group">
                <label for="reject2" class="col-md-3 control-label">Upload Reject 2</label>
                <div class="col-sm-5">	  
                    <input type="file" id="reject2" name="reject2"><span style="color:red;"><?php if($cek>0){echo $rcek['reject2'];} ?></span>
                    <span class="help-block with-errors"></span>
                </div>	  
            </div>  
			<div class="form-group">
                <label for="reject3" class="col-md-3 control-label">Upload Reject 3</label>
                <div class="col-sm-5">	  
                    <input type="file" id="reject3" name="reject3"><span style="color:red;"><?php if($cek>0){echo $rcek['reject3'];} ?></span>
                    <span class="help-block with-errors"></span>
                </div>	  
            </div>   	 	
	 	</div>
	...
	<?php
	$sqlCekold=mysqli_query($con,"SELECT * FROM tbl_tq_nokk WHERE nokk='$Nokkold' ORDER BY id DESC LIMIT 1");
	...
	CONCAT_WS(' ',mfc_note,mph_note, mabr_note, mbas_note, mdry_note, mfla_note, mfwe_note, mfwi_note, mburs_note,mrepp_note,mwick_note,mabsor_note,mapper_note,mfiber_note,mpillb_note,mpillm_note,mpillr_note,mthick_note,mgrowth_note,mrecover_note,mstretch_note,msns_note,msnab_note,msnam_note,msnap_note,mwash_note,mwater_note,macid_note,malkaline_note,mcrock_note,mphenolic_note,mcm_printing_note,mcm_dye_note,mlight_note,mlight_pers_note,msaliva_note,mh_shrinkage_note,mfibre_note,mpilll_note,msoil_note,mapperss_note,mbleeding_note,mchlorin_note,mdye_tf_note,mhumidity_note,modour_note) AS mnote_g FROM tbl_tq_marginal WHERE id_nokk='$rcekold[id]' ORDER BY id DESC LIMIT 1");
	$cekM=mysqli_num_rows($sqlCekM);
	$rcekM=mysqli_fetch_array($sqlCekM);
	?>	 
   	<div class="box-footer"> 
   		<?php if($nokk!="" OR $nokk_post!=""){ ?>
			<button type="submit" class="btn btn-primary pull-right" name="save1" value="save"><i class="fa fa-save"></i> Simpan</button>
		<?php } ?>
		<?php if($rcekNew['status']!="" AND strpos($rcek['no_item'],'DPQ19075') !== false){ ?>
			<a href="pages/cetak/cetak_report_ua_dpq19075.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a>
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'R1118417') !== false){ ?>
			<a href="pages/cetak/cetak_report_ua_r1118417.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a>
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'F3C18416') !== false){ ?>
			<a href="pages/cetak/cetak_report_ua_f3c18416.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a>
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'R1118420') !== false){?>
			<a href="pages/cetak/cetak_report_ua_r1118420.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a>
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'DKI18362') !== false){?>
			<a href="pages/cetak/cetak_report_ua_dki18362.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a>
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'R2219205') !== false){?>
			<a href="pages/cetak/cetak_report_ua_r2219205.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a> 
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'F3T21112') !== false){?> 
			<a href="pages/cetak/cetak_report_ua_f3t21112.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a> 
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'F3T21113') !== false){?>
			<a href="pages/cetak/cetak_report_ua_f3t21113.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a> 
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'R2217357') !== false){?>
			<a href="pages/cetak/cetak_report_ua_r2217357.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a> 
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'R1120207') !== false){?>
			<a href="pages/cetak/cetak_report_ua_r1120207.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a> 
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'R2218395') !== false){?>
			<a href="pages/cetak/cetak_report_ua_r2218395.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a> 
		<?php }else if($rcekNew['status']!="" AND strpos($rcek['no_item'],'DPQ19138') !== false){?>
			<a href="pages/cetak/cetak_report_ua_dpq19138.php?idkk=<?php echo $rcek['id'];?>&noitem=<?php echo $rcek['no_item'];?>&nohanger=<?php echo $rcek['no_hanger'];?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Report Under Armour</a> 
		<?php }?>
   	</div>
    <!-- /.box-footer -->
</div>
<?php if($_GET['nokk']!="" OR $_GET['notest']!=""){?>
<div class="box box-success">
   	<div class="box-header with-border">
    	<h3 class="box-title">No KK Lama</h3>
		<div class="box-tools pull-right">
			<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
		</div>
  	</div>
    <div class="box-body">
        <div class="col-md-6">
            <div class="form-group">
				<label for="no_kkold" class="col-sm-3 control-label">No KK</label>
				<div class="col-sm-4">
                    <input name="no_kkold" type="text" class="form-control" id="no_kkold" placeholder="No KK" autocomplete="off" 
                    value="<?php if($Nokkold!=""){ echo $Nokkold;} ?>" >
				</div>
					...
					<form class="form-horizontal" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
						<div class="form-group">
          					...
          					<div class="col-sm-4">
              					...
              					<option selected="selected" value="">Pilih</option>
								<?php
								$sql = "SELECT a.*, b.* From tbl_tq_nokk a INNER JOIN tbl_master_test b ON a.no_test=b.no_testmaster WHERE nokk='$Nokkold'";
						...
						<div class="form-group" id="disbsk" style="display:none;">
							...
							<div class="col-sm-2">
								<textarea class="form-control" placeholder="Note harus diakhir tanda titik" name="dbas_note" maxlength="50" rows="1"><?php echo $rcekD['dbas_note'];?></textarea>
							</div>
						</div>
						...
						<div class="form-group" id="ranbsk" style="display:none;">
							...
							<div class="col-sm-2">
								<textarea class="form-control" placeholder="Note harus diakhir tanda titik" name="rbas_note" maxlength="50" rows="1" readonly><?php echo $rcekR['rbas_note'];?></textarea>
							</div>
						</div>
						<!-- BOW & SKEW END-->
						...
						<div class="form-group" id="fc24" style="display:none;">
							...
							<div class="col-sm-2">
								<textarea class="form-control" placeholder="Note harus diakhir tanda titik" name="apperss_note" maxlength="50"><?php echo $rcek1['apperss_note'];?></textarea>
							</div>
						</div>
						...
						<div class="form-group" id="disapss" style="display:none;">
							...
							<div class="col-sm-2">
								<textarea class="form-control" placeholder="Note harus diakhir tanda titik" name="dapperss_note" maxlength="50"><?php echo $rcekD['dapperss_note'];?></textarea>
							</div>
						</div>
						<div class="form-group" id="marapss" style="display:none;">
							...
							<div class="col-sm-2">
								<textarea class="form-control" placeholder="Note harus diakhir tanda titik" name="mapperss_note" maxlength="50"><?php echo $rcekM['mapperss_note'];?></textarea>
							</div>
						</div>
						<div class="form-group" id="ranapss" style="display:none;">
							...
							<div class="col-sm-2">
								<textarea class="form-control" placeholder="Note harus diakhir tanda titik" name="rapperss_note" maxlength="50" readonly><?php echo $rcekR['rapperss_note'];?></textarea>
							</div>
						</div>
						...
						<div class="form-group" id="disrc" style="display:none;">
							...
							<div class="col-sm-1">
								...
								<input name="drecover_l11" type="text" class="form-control" id="drecover_l11" value="<?php echo $rcekD['drecover_l11'];?>" placeholder="LEN30 1">
								<input name="drecover_w1" type="text" class="form-control" id="drecover_w1" value="<?php echo $rcekD['drecover_w1'];?>" placeholder="WID1 1">
								<input name="drecover_w11" type="text" class="form-control" id="drecover_w11" value="<?php echo $rcekD['drecover_w11'];?>" placeholder="WID30 1">
							</div>
							<div class="col-sm-1">
								<input name="drecover_l2" type="text" class="form-control" id="drecover_l2" value="<?php echo $rcekD['drecover_l2'];?>" placeholder="LEN1 2">
								...
								<input name="drecover_w2" type="text" class="form-control" id="drecover_w2" value="<?php echo $rcekD['drecover_w2'];?>" placeholder="WID1 2">
						...
						<div class="form-group" id="dishs" style="display:none;">
								...
								<div class="col-sm-2">
									<input name="dh_shrinkage_app" type="text" class="form-control" id="dh_shrinkage_app" value="<?php echo $rcek1['dh_shrinkage_app'];?>" placeholder="PASS/FAIL">
								</div>
								<div class="col-sm-2">
...
`tgl_update`=now()");
		...
		if (result.value) {
			...
			window.location.href='ReportUA-$nokk'; 
		}
		});</script>";
	}
...
if($_POST['save1']=="save"){
	...
	$jenis_kain=str_replace("'","''",$Jns_Kain);
	$prev=str_replace("'","''",$Prev_Rpt);
	$testtype=str_replace("'","''",$Test_Type);
	$fabric_fin=str_replace("'","''",$Fabric_Finish);
	$date_in=$DateIn;
	$date_in_m = substr($date_in,5,2);
	$date_in_d = substr($date_in,8,2);
	$date_in_y = substr($date_in,0,4);
	...
	// ambil data file
	$namaFile_cover = $_FILES['cover']['name'];
	...
	$namaSementara_reject3 = $_FILES['reject3']['tmp_name'];
	// tentukan lokasi file akan dipindahkan
	$dirUpload = "dist/img-rptua/";
	// pindahkan file

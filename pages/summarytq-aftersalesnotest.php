...
$qry=mysqli_query($con,"SELECT a.*, a.id AS idkk, b.* From tbl_tq_nokk a INNER JOIN tbl_master_test b ON a.no_test=b.no_testmaster WHERE no_test='$Notest'");
    ...
    <div class="box-body"> 
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input name="no_order" type="text" class="form-control" id="no_order" placeholder="No Order" onchange="window.location='index1.php?p=summarytq-aftersales&amp;no_order='+this.value" 
                    value="<?php if($cekd>0){echo $rd['no_order'];}else {echo $_GET['no_order'];}?>">
                </div>				   
            </div>
            <div class="form-group">
                <label for="no_test" class="col-sm-3 control-label">No Test</label>
                <div class="col-sm-5">
                    <input name="no_po" type="text" class="form-control" id="no_po" placeholder="No PO" value="<?php echo $_GET['no_test'];?>" readonly>
                </div>
            </div>
            <div class="form-group">
                <label for="no_po" class="col-sm-3 control-label">No PO</label>
                <div class="col-sm-5">
                    <input name="no_po" type="text" class="form-control" id="no_po" placeholder="No PO" value="<?php if($cekd>0){echo $rd['no_po'];}else {echo $_GET['no_po'];}?>" onchange="window.location='index1.php?p=summarytq-aftersalespo&amp;no_po='+this.value">
                </div>				   
            </div> 
            <div class="form-group">
                <label for="nokk" class="col-sm-3 control-label">No KK</label>
                <div class="col-sm-5">
                    <input name="nokk" type="text" class="form-control" id="nokk" placeholder="No KK" value="<?php if($cekd>0){echo $rd['nokk'];}?>" readonly>
                </div>				   
            </div>
        </div>
        <div class="col-md-6">
                  ...
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-hover table-striped" width="100%"> 
                        ...
                        <tbody>
                                ...
                                $posbuyer=substr($row['pelanggan'],$pos+1,50);
                                $buyer=str_replace("'","''",$posbuyer);
                                ?>
                            <?php if(in_array("FLAMMABILITY",$detail)){?>
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("FLAMMABILITY",$detail)){echo "FLAMMABILITY";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_fla']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_fla";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_fla']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_fla";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_fla']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_fla";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_fla']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_fla";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_fla']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_fla";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_fla']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_fla";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("FIBER CONTENT",$detail)){echo "FIBER CONTENT";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_fib']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_fib";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_fib']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_fib";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_fib']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_fib";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_fib']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_fib";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_fib']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_fib";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_fib']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_fib";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("FABRIC COUNT",$detail)){echo "FABRIC COUNT";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("BOW & SKEW",$detail)){echo "BOW & SKEW";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("PILLING MARTINDLE",$detail)){echo "PILLING MARTINDLE";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_pm']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_pm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_pm']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_pm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_pm']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_pm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_pm']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_pm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>  
                                <?php }else if($row['stat_pm']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_pm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_pm']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_pm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_pm']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_pm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_pm']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_pm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?> 
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("PILLING LOCUS",$detail)){echo "PILLING LOCUS";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY",$detail)){echo "FABRIC WEIGHT";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_fwss2']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_fwe";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_fwss2']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_fwe";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_fwss2']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_fwe";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_fwss2']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_fwe";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>   
                                <?php }else if($row['stat_fwss2']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_fwe";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_fwss2']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_fwe";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_fwss2']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_fwe";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_fwss2']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_fwe";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?> 
                                </td>
                            ...
                            <?php if(in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY",$detail)){?>
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY",$detail)){echo "FABRIC WIDTH";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_fwss3']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_fwi";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_fwss3']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_fwi";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_fwss3']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_fwi";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_fwss3']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_fwi";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>   
                                <?php }else if($row['stat_fwss3']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_fwi";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_fwss3']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_fwi";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_fwss3']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_fwi";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_fwss3']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_fwi";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?> 
                                </td>
                            ...
                            <?php if(in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY",$detail)){?>
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY",$detail)){echo "SHRINKAGE & SPIRALITY";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_fwss']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_ss";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_fwss']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_ss";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_fwss']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_ss";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_fwss']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_ss";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>   
                                <?php }else if($row['stat_fwss']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_ss";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_fwss']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_ss";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_fwss']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_ss";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_fwss']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_ss";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?> 
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("PILLING BOX",$detail)){echo "PILLING BOX";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("PILLING RANDOM TUMBLER",$detail)){echo "PILLING RANDOM TUMBLER";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_prt']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_prt";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_prt']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_prt";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_prt']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_prt";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_prt']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_prt";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_prt']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_prt";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_prt']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_prt";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("ABRATION",$detail)){echo "ABRATION";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("SNAGGING MACE",$detail)){echo "SNAGGING MACE";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("SNAGGING POD",$detail)){echo "SNAGGING POD";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_sp']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_sp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_sp']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_sp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_sp']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_sp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_sp']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_sp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_sp']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_sp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_sp']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_sp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?> 
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("BEAN BAG",$detail)){echo "BEAN BAG";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("BURSTING STRENGTH",$detail)){echo "BURSTING STRENGTH (INSTRON)";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_bs2']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_bb";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_bs2']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_bb";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_bs2']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_bb";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_bs2']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_bb";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>  
                                <?php }else if($row['stat_bs2']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_bb";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_bs2']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_bb";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_bs2']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_bb";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_bs2']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_bb";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("BURSTING STRENGTH",$detail)){echo "BURSTING STRENGTH (MULLEN)";} ?></a></td>
                                <td align="center" >
                            ...
                            <?php if($row['bs_tru']!=""){?>
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("BURSTING STRENGTH",$detail)){echo "BURSTING STRENGTH (TRU)";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_bs']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_bs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_bs']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_bs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_bs']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_bs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_bs']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_bs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>   
                                <?php }else if($row['stat_bs']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_bs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_bs']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_bs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_bs']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_bs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_bs']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_bs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?> 
                                </td>
                                <td align="center" ><?php if($row['burs_note']!=""){echo $row['burs_note'];}?></td>
                            </tr>
                            <?php } ?>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("THICKNESS",$detail)){echo "THICKNESS";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("STRETCH & RECOVERY",$detail)){echo "STRETCH & RECOVERY";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_sr']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_sr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_sr']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_sr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_sr']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_sr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_sr']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_sr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span> 
                                <?php }else if($row['stat_sr']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_sr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_sr']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_sr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_sr']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_sr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_sr']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_sr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("GROWTH",$detail)){echo "GROWTH";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("APPEARANCE",$detail)){echo "APPEARANCE";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("HEAT SHRINKAGE",$detail)){echo "HEAT SHRINKAGE";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_hs']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_hs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_hs']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_hs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_hs']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_hs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_hs']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_hs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_hs']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_hs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_hs']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_hs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?> 
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("FIBRE/FUZZ",$detail)){echo "FIBRE/FUZZ";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_ff']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_ff";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_ff']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_ff";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_ff']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_ff";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_ff']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_ff";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_ff']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_ff";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_ff']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_ff";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("ODOUR",$detail)){echo "ODOUR";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("WICKING",$detail2)){echo "WICKING";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_wic']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_wic";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_wic']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_wic";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_wic']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_wic";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_wic']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_wic";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>   
                                <?php }else if($row['stat_wic']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_wic";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_wic']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_wic";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_wic']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_wic";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_wic']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_wic";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("ABSORBENCY",$detail2)){echo "ABSORBENCY";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_abs']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_abs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_abs']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_abs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_abs']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_abs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_abs']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_abs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_abs']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_abs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_abs']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_abs";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("DRYING TIME",$detail2)){echo "DRYING TIME";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_dry']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_dry";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_dry']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_dry";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_dry']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_dry";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_dry']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_dry";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>    
                                <?php }else if($row['stat_dry']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_dry";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_dry']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_dry";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_dry']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_dry";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_dry']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_dry";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("WATER REPPELENT",$detail2)){echo "WATER REPPELENT";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_wp']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_wr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_wp']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_wr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_wp']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_wr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_wp']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_wr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_wp']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_wr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_wp']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_wr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?> 
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("PH",$detail2)){echo "PH";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_ph']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_ph";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_ph']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_ph";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_ph']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_ph";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_ph']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_ph";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>  
                                <?php }else if($row['stat_ph']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_ph";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_ph']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_ph";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_ph']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_ph";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_ph']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_ph";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("SOIL RELEASE",$detail2)){echo "SOIL RELEASE";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("HUMIDITY",$detail2)){echo "HUMIDITY";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("WASHING",$detail3)){echo "WASHING";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_wf']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_wash";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_wf']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_wash";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_wf']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_wash";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_wf']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_wash";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>   
                                <?php }else if($row['stat_wf']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_wash";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_wf']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_wash";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_wf']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_wash";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_wf']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_wash";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("PERSPIRATION ACID",$detail3)){echo "PERSPIRATION ACID";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_pac']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_pac";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_pac']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_pac";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_pac']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_pac";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_pac']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_pac";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span> 
                                <?php }else if($row['stat_pac']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_pac";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_pac']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_pac";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_pac']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_pac";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_pac']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_pac";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("PERSPIRATION ALKALINE",$detail3)){echo "PERSPIRATION ALKALINE";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_pal']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_pal";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_pal']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_pal";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_pal']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_pal";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_pal']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_pal";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>  
                                <?php }else if($row['stat_pal']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_pal";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_pal']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_pal";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_pal']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_pal";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_pal']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_pal";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("WATER",$detail3)){echo "WATER";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_wtr']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_wat";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_wtr']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_wat";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_wtr']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_wat";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_wtr']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_wat";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>   
                                <?php }else if($row['stat_wtr']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_wat";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_wtr']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_wat";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_wtr']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_wat";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_wtr']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_wat";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("CROCKING",$detail3)){echo "CROCKING";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_cr']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_cr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_cr']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_cr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_cr']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_cr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_cr']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_cr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>  
                                <?php }else if($row['stat_cr']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_cr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_cr']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_cr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_cr']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_cr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_cr']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_cr";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("PHENOLIC YELLOWING",$detail3)){echo "PHENOLIC YELLOWING";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_py']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_py";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_py']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_py";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_py']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_py";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_py']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_py";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span> 
                                <?php }else if($row['stat_py']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_py";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_py']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_py";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_py']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_py";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_py']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_py";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("LIGHT",$detail3)){echo "LIGHT";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_lg']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_lf";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_lg']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_lf";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_lg']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_lf";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_lg']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_lf";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_lg']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_lf";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_lg']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_lf";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("COLOR MIGRATION-OVEN TEST",$detail3)){echo "COLOR MIGRATION-OVEN TEST";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("COLOR MIGRATION",$detail3)){echo "COLOR MIGRATION";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_cm']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_cm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_cm']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_cm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_cm']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_cm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_cm']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_cm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_cm']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_cm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_cm']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_cm";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?> 
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("LIGHT PERSPIRATION",$detail3)){echo "LIGHT PERSPIRATION";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_lp']=="DISPOSISI"){?> <span class='label bg-yellow blink_me <?php if($buyer=="ADIDAS"){echo "std_lp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_lp']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_lp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span>
                                <?php }else if($row['stat_lp']=="MARGINAL PASS"){?> <span class='label bg-purple <?php if($buyer=="ADIDAS"){echo "std_lp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "MARGINAL PASS"; ?></span> 
                                <?php }else if($row['stat_lp']=="DATA"){?> <span class='label bg-blue <?php if($buyer=="ADIDAS"){echo "std_lp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DATA"; ?></span>  
                                <?php }else if($row['stat_lp']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_lp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_lp']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_lp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_lp']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_lp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_lp']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_lp";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("SALIVA",$detail3)){echo "SALIVA";} ?></a></td>
                                <td align="center" >
                                <?php if($row['stat_slv']=="DISPOSISI"){?> <span class='label label-bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_sl";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "DISPOSISI"; ?></span> 
                                <?php }else if($row['stat_slv']=="FAIL"){?> <span class='label bg-red blink_me <?php if($buyer=="ADIDAS"){echo "std_sl";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "FAIL"; ?></span> 
                                <?php }else if($row['stat_slv']=="PASS"){?> <span class='label bg-green <?php if($buyer=="ADIDAS"){echo "std_sl";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "PASS"; ?></span>
                                <?php }else if($row['stat_slv']=="R"){?> <span class='label bg-orange <?php if($buyer=="ADIDAS"){echo "std_sl";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "R"; ?></span>
                                <?php }else if($row['stat_slv']=="RANDOM"){?> <span class='label bg-maroon <?php if($buyer=="ADIDAS"){echo "std_sl";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "RANDOM"; ?></span>
                                <?php }else if($row['stat_slv']=="A"){?> <span class='label bg-teal <?php if($buyer=="ADIDAS"){echo "std_sl";} ?>' id="<?php echo $row['no_test']; ?>"><?php echo "A"; ?></span> <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("BLEEDING",$detail3)){echo "BLEEDING";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("CHLORIN & NON-CHLORIN",$detail3)){echo "CHLORIN";} ?></a></td>
                                <td align="center" >
                            ...
                            <?php if(in_array("CHLORIN & NON-CHLORIN",$detail3)){?>
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("CHLORIN & NON-CHLORIN",$detail3)){echo "NON-CHLORIN";} ?></a></td>
                                <td align="center" >
                            ...
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nokk'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("DYE TRANSFER",$detail3)){echo "DYE TRANSFER";} ?></a></td>
                                <td align="center" >
            ...
            <div class="box-header">
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                                <label for="approve" class="col-sm-4 control-label">APPROVED BY</label>
                                <div class="col-sm-5">
                                    <input name="approve" type="text" class="form-control" id="approve" placeholder="" value="<?php echo $rcek1['approve'];?>" readonly="readonly">
                                </div>				   
                            </div>
                        <div class="form-group">					
                            <?php if($no_test!=""){ ?>
                                <button type="submit" class="btn btn-primary pull-right" name="status_save" value="save" <?php if($_SESSION['akses']=='biasa' OR $_SESSION['lvl_id']=='AFTERSALES' OR ($rcek1['status']!='' AND $_SESSION['nama1']!='Janu Dwi Laksono')){ echo "disabled"; } ?>><i class="fa fa-save"></i> Simpan Status</button>
                            <?php } ?>
                        </div>
                    </div>
                    </form>
...
if($_POST['status_save']=="save" and $_POST['status']==""){
  echo "<script>swal({
    ...
    if (result.value) {
     ...
     window.location.href='SummaryTQAftersalesNoTest-$Notest'; 
    }
  });</script>";
...
if($no_test!="" and $cekd==0){
 ...
 if (result.value) {
    ...
    window.location.href='SummaryTQAftersalesNoTest'; 
 }
});</script>";
}
?>
<div id="StdFla" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdFib" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdHs" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdPrt" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdSs" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdBs" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdFwe" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdFwi" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdSr" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdFf" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdSp" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdBb" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdPm" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdPh" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdWash" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdPac" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdPal" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdWat" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdCr" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdPy" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdLf" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdCm" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdLp" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdSl" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdAbs" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdWic" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdDry" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
<div id="StdWr" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>